  ...
  <tr>
    ...
    <td width="774" valign="top" bgcolor="#f8f8f8"><table width="774" border="0" cellpadding="0" cellspacing="0" background="images/products_03.jpg">
      <tr>
        ...
        <td width="105" class="zhans">推荐产品</td>
        <td width="627" align="right" class="weiz" style="padding-right:20px;">当前位置：<a href="index.asp">首页</a> &gt;&gt; 推荐产品</td>
      </tr>
    </table>
          ...
          <td style="padding-top:8px; padding-left:11px;"><table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <%	
					...
					sql="select id,title,img_sl from info_co where pass='yes' and lm=2 order by px desc,id desc"
              ...
              <td width="186"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="171" height="154" align="center" class="bk"><a href="hot_pro_show.asp?id=<%=rs("id")%>"><img src="../<%=rs("img_sl")%>" border="0" /></a></td>
                </tr>
                <tr>
                  <td height="30" align="center"><a style="color:#333333;" href="hot_pro_show.asp?id=<%=rs("id")%>"><%=getstr(rs("title"),24)%></a></td>
                </tr>
                <tr>
                  <td height="15">&nbsp;</td>
                </tr>
