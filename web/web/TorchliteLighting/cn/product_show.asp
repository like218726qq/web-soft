...
<%
	...
	sql="select title_lm,id_lm from pro_lm where id_lm="&lm&" "
  ...
  <tr>
    ...
    <td width="774" valign="top" bgcolor="#f8f8f8"><table width="774" border="0" cellpadding="0" cellspacing="0" background="images/products_03.jpg">
      <tr>
        ...
        <td width="627" align="right" class="weiz" style="padding-right:20px;">当前位置：<a href="index.asp">首页</a> &gt;&gt; <a href="product.asp">产品中心</a>  <a href="product.asp?lm=<%=id_lm%>"><%=dao%></a> &gt;&gt; <%=title%></td>
      </tr>
    </table>
        ...
        <tr>
          <td style="padding-top:8px; padding-left:11px;">
            ...
            <a href="product_show.asp?ID=<%=rs("ID")%>"><img src="images/down.gif" border="0" align="absmiddle" /></a>
                ...
                <%=z_body%>
                <div class="back" style="text-align:right;"><a style="color:#000000;" href="product.asp">[返回]</a></div>
            </div>
          </td>
        </tr>
      </table>
