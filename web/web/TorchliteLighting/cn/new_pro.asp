  ...
  <tr>
    ...
    <td width="774" valign="top" bgcolor="#f8f8f8"><table width="774" border="0" cellpadding="0" cellspacing="0" background="images/products_03.jpg">
      <tr>
        ...
        <td width="627" align="right" class="weiz" style="padding-right:20px;">当前位置：<a href="index.asp">首页</a> &gt;&gt; 新产品</td>
      </tr>
    </table>
          ...
          <td style="padding-top:8px; padding-left:11px;"><table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <%	
					...
					sql="select id,title,img_sl from pro_co where pass='yes' and hot='yes' order by px desc,id desc"
              ...
              <td width="186"><table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="30" align="center"><a style="color:#333333;" href="new_pro_show.asp?id=<%=rs("id")%>"><%=getstr(rs("title"),24)%></a></td>
                </tr>
                <tr>
                  <td height="15">&nbsp;</td>
                </tr>
