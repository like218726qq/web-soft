  ...
  <tr>
    ...
    <td width="774" valign="top" bgcolor="#f8f8f8"><table width="774" border="0" cellpadding="0" cellspacing="0" background="images/products_03.jpg">
      <tr>
        ...
        <td width="627" align="right" class="weiz" style="padding-right:20px;">Location：<a href="index.asp">Home</a> &gt;&gt; Recommended Products</td>
      </tr>
    </table>
          ...
          <td style="padding-top:8px; padding-left:11px;"><table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <%	
					...
					sql="select id,title,img_sl from info_co where pass='yes' and lm=5 order by px desc,id desc"
