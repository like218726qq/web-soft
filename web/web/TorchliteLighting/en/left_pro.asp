<table width="213" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="32" background="images/fenl.jpg" class="font_" style="padding-left:55px;">Products</td>
      </tr>
      <tr>
        <td background="images/fenl_beij.jpg" style="padding-top:6px; padding-left:22px;">
          ...
          <tr>
            <td height="22" class="fenl"><a href="product.asp?lm=<%=rs("id_lm")%>"><%=getstr(rs("title_lm_en"),18)%></a></td>
          </tr>
          <tr>
            <td height="12"></td>
          </tr>
