  ...
  <tr>
    ...
    <td width="774" valign="top" bgcolor="#f8f8f8"><table width="774" border="0" cellpadding="0" cellspacing="0" background="images/products_03.jpg">
      <tr>
        ...
        <td width="627" align="right" class="weiz" style="padding-right:20px;">Location：<a href="index.asp">Home</a> &gt;&gt; News</td>
      </tr>
    </table>
        ...
        <tr>
          <td style="padding-top:15px; padding-left:11px;">
          	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                   ...
                   %>
                       <div style="text-align:center; margin-top:100px; margin-left:200px; width:200px; vertical-align:top; font-size:12px;">No information!</div>
                    <%		
                    end if	
					rs.close
					set rs=nothing
