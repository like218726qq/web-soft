  ...
  <tr>
    ...
    <td width="774" valign="top" bgcolor="#f8f8f8"><table width="774" border="0" cellpadding="0" cellspacing="0" background="images/products_03.jpg">
      <tr>
        ...
        <td width="105" class="zhans">News</td>
        <td width="627" align="right" class="weiz" style="padding-right:20px;">Location：<a href="index.asp">Home</a> &gt;&gt; <a href="news.asp">News</a></td>
      </tr>
    </table>
        ...
        <tr>
          <td style="padding-top:15px; padding-left:11px;">
			...
			<table width="98%" align="center">
				...
				<tr>
					<td height="20" align="center" bgcolor="#E0E0E0" style="border-bottom-width: 1px;border-bottom-style: solid;border-bottom-color: #E0E0E0;font-size:12px;">Date:<%=FormatDateTime(rs("wtime"),2)%> &nbsp;  | &nbsp; Read:<%=rs("read_num")%></td>
				</tr>
				<tr>
				...
				<tr>
					<td height="30" align="right" style="padding-right:20px;"><a href="javascript:history.go(-1)" style="text-decoration:none;">[ Return ]</a></td>
				</tr>
			</table>
			<%
				rs.close
