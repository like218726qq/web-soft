  ...
  <TD>
    ...
    <TR class="tdbg">
		...
		<TD>
		  ...
		  <FONT color=red>*</FONT>
	    <input name="title_lm_bl" type="text" id="title_lm_bl" size="30" maxlength="150" />
	...
	<TR class="tdbg">
      ...
      <TD>
        ...
        <TD>
			<input name="xia" type="radio" value="yes">
		  是
			<input name="xia" type="radio"  value="no" checked="checked">
		  否 有下级分类</TD>    
    </TR>
	 <TR class="tdbg">
		  <TD width="120" align="right">
