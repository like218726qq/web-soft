...
<%
	...
	if id<>"" and checknum(id) then
		...
		sql="select top 1 * from info_co where lm=18 order by px desc,id desc"
	end if
...
<div class="box-2">
 ...
 <br/>
       ...
       <ul class="n-list">
              <li><a href="contact.asp?id=10" class="p1">Contact Us</a></li>
            <li><a href="site.asp"  class="p1">Site Map</a></li>
            <li><a href="contact.asp?id=12"  class="p1">Jobs</a> </li>
            </ul>
    ...
    <div class="pro-right-bar">
   	  <div class="proT"><p>Contact Us  <%=dao%></p></div>
      <div class="proM">
      <table border="0" cellpadding="0" cellspacing="0">
