...
<%
	...
	if lm<>"" then
		if not checknum(lm) then
			...
			sql="select a.id_lm,a.title_lm_en as xtitle,b.title_lm_en as dtitle from pro_lm a, pro_lm b where a.fid=b.id_lm and a.id_lm="&lm&""
...
<div class="box-2">
  ...
  <div class="pro-left-bar">
    ...
    <div class="pro-right-bar">
   	  <div class="proT"><p>Products <%=dao%></p></div>
      <div class="proM">
...
<a href="product_show.asp?id=<%=rs("id")%>&dlm=<%=dlm%>"><img src="../<%=rs("img_sl")%>" width="200" height="200" /></a>
      ...
      <tr><td style=" height:30px;" align="center"><%if pagenum<>"" then call listpageen(pra) end if%></td></tr>
      </table>
      </div>
