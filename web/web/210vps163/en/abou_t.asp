...
<div class="box-2">
 ...
 <br/>
            <ul class="n-list">
        <li><a href="abou_t.asp" class="p1">About us</a></li>
         <li><a href="team.asp"  class="p1">Teamwork </a></li>
		 <li><a href="culture.asp"  class="p1">Our Culture </a></li>
            </ul>
    ...
    <div class="pro-right-bar">
      ...
      <tr><td style=" width:661px; height:40px; font-weight:bold;">&nbsp;</td>
	   ...
	   <tr><td style=" width:661px; height:29px; background:url(images/kuangjia_03.jpg) left top no-repeat;"></td></tr>
		 ...
		 <!--con0-->
	<table border="0" cellpadding="0" align="center" cellspacing="0">
      <tr><td style=" width:100px; height:30px;">&nbsp;</td><td  style=" width:500px; height:30px; font-size:14px; font-weight:bold;"><span style=" width:661px; height:40px; font-weight:bold;">TARGET</span></td>
      </tr>
	  
      <tr><td style=" width:100px; height:58px;" align="center" valign="middle"><img src="images/fd.jpg" alt="" width="58" height="58"  /></td>
    ...
    <!--con-->
      ...
      <tr><td style=" width:661px; height:40px; font-weight:bold;">&nbsp;</td>
	   ...
	   <tr><td style=" width:661px; height:29px; background:url(images/kuangjia_03.jpg) left top no-repeat;"></td></tr>
         ...
         <!--con-->
<table border="0" cellpadding="0" align="center" cellspacing="0">
      <tr><td style=" width:100px; height:30px;">&nbsp;</td><td  style=" width:500px; height:30px; font-size:14px; font-weight:bold;">MISSION</td></tr>
    ...
    <!--con-->
      ...
      <tr><td style=" width:661px; height:40px; font-weight:bold;">&nbsp;</td>
	   ...
	   <tr><td style=" width:661px; height:29px; background:url(images/kuangjia_03.jpg) left top no-repeat;"></td></tr>
         ...
         <!--con2-->
<table border="0" cellpadding="0" align="center" cellspacing="0">
      <tr><td style=" width:100px; height:30px;">&nbsp;</td><td  style=" width:500px; height:30px; font-size:14px; font-weight:bold;">PROFILE</td></tr>
...
<table border="0" cellpadding="0" align="center" cellspacing="0">
      ...
      <tr><td style=" width:100px; height:30px;">&nbsp;</td><td  style=" width:500px; height:30px; font-size:14px; font-weight:bold;">PRODUCT LINES</td></tr>
