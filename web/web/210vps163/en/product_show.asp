...
<div class="box-2">
  ...
  <div class="pro-left-bar">
    ...
    <div class="pro-right-bar">
	  ...
	  <tr><td style=" width:490px; height:45px;" align="right"><a href="javascript:history.back();" style=" font-size:13px;">[back]</a></td>
...
<span><%=pro_danwei_en%></span>
</div>
<div id="test2_3" class="tablist">
<span><%=pro_color_en%></span>
</div>
<div id="test2_4" class="tablist">
<span><%=pro_guige_en%></span>
</div>
<div id="test2_5" class="tablist">
<span><%=pro_money_en%></span>
</div>
...
new tab('test2_li_now_');
           ...
           <!--end ny2-2-->
           <div class="ny2-line">
           <div class="divpro_de_detail_span"><a href="javascript:history.back();">[back]</a></div><br/>
