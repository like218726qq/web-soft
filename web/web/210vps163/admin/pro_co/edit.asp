...
if rs.eof then 
	...
	pro_danwei_en=rs("pro_danwei_en")
	pro_guige=rs("pro_guige")
	pro_guige_en=rs("pro_guige_en")
	pro_color=rs("pro_color")
	pro_color_en=rs("pro_color_en")
	pro_money=rs("pro_money")
	pro_money_en=rs("pro_money_en")
...
<input  type="hidden" name="w_url" value="<%=w_url%>">
      <table width="1300" border="0" cellpadding="2" cellspacing="1" class="border">
        <tr class="title">
          <td  align="center" colspan="4" >产品修改</td>
        </tr>
		<tr class="tdbg">
          ...
          <tr class="tdbg">
            ...
            <td ><input name="title" type="text" id="title" value="<%=title%>" size="30" maxlength="150"></td><td></td><td></td>
          </tr>
          <tr class="tdbg">
            <td width="120" align="right"><strong>产品英文名称：</strong></td>
            <td ><input name="title_en" type="text" id="title_en" value="<%=title_en%>" size="30" maxlength="150"></td><td></td><td></td>
          </tr>
     <!--开始-->
  <tr class="tdbg">
                <td width="120" align="right"><strong>简要介绍：</strong></td>
                <td>
				  <textarea name="f_body" cols="62" rows="4" id="f_body"><%=f_body%></textarea>				</td>
                <td  width="120" align="right"><strong>简要介绍(英文)：</strong></td><td><textarea name="f_body_en" cols="62" rows="4" id="f_body_en"><%=f_body_en%></textarea></td>
          </tr>
              <tr class="tdbg">
    ...
    %>	                </td>  <td  width="120" align="right"><strong >英文详细介绍：(spicificaions)</strong></td><td><%
    ...
    %></td>        
           ...
           <tr class="tdbg2">
            <td width="120" align="right" class="tdbg"><p><strong>尺寸图</strong><strong>：</strong></td>
        <td class="tdbg">               
    <%
    oFCKeditor.Value = pro_danwei
    oFCKeditor.Create "pro_danwei"
    %>
        
        </td>
        <td class="tdbg" align="right"><strong>(dimension drawing)：</strong></td><td class="tdbg"><%
    oFCKeditor.Value = pro_danwei_en
...
<td class="tdbg" > <%
		oFCKeditor.Value = pro_color
    oFCKeditor.Create "pro_color"
    %></td><td  class="tdbg" align="right"><strong>(lumen)：</strong></td><td  class="tdbg"><%
		oFCKeditor.Value = pro_color_en
...
<td class="tdbg" ><strong>
            <%
		oFCKeditor.Value = pro_guige
    oFCKeditor.Create "pro_guige"
    %>
            </strong></td><td  align="right" class="tdbg"><strong>(dmx channels)：</strong></td><td class="tdbg"><strong>
            <%
		oFCKeditor.Value = pro_guige_en
...
<td class="tdbg" >
            <strong>
            <%
		oFCKeditor.Value = pro_money
    oFCKeditor.Create "pro_money"
    %>
            </strong></td><td  align="right" class="tdbg"><strong>(related products)：</strong></td><td class="tdbg"><strong>
            <%
		oFCKeditor.Value = pro_money_en
...
<tr class="tdbg" >          
                ...
                <td  class="tdbg" colspan="3"><IFRAME id="fra" name="fra"  height=240 src="../pro_img/img_add.asp?pro_id=<%=id%>" width="630" frameborder=0 scrolling="auto"></iframe></td>
        </tr>
            <tr class="tdbg">
    <td align="right"><STRONG>显示顺序：</STRONG></td>
    <td colspan="3"><input name="px" type="text" id="px" value="<%=px%>" size="10" maxlength="10" >
