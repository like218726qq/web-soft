...
%>
    ...
    <div class="pro-right-bar">
      ...
      <tr>
        <td style=" height:20px; padding-right:30px;" align="right">时间：<%=wtime%></td></tr>
        <tr>
        ...
        <tr>
        <td style=" height:20px; padding-right:30px;" align="right"><a href="javascript:history.back();">[返回]</a></td></tr>
      </table>
      <!--结束-->
      </td></tr>
      </table>
