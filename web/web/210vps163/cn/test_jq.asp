...
<div class="pop_box">
 ...
 <TABLE cellSpacing=3 cellPadding=0 width="95%" align=left border=0>
              ...
              <TR>
                <TD class=font_bot width=77 height=35>用户名</TD>
              ...
              <TR>
                ...
                <tr><td style="width:69px; height:23px"> <INPUT id=back_url type=hidden name=back_url value="<%=request("back_url")%>"><INPUT type=image src="images/login123.jpg" value=提交 name=Submit></td><td style=" width:10px;"></td>
