...
<div id="MAIN">
    ...
    <div id="con_main">
        <div id="left">
            <div id="co">
                <div class="co_title"><img src="images/pro_03_03.jpg" /></div>
                <div class="co_list">
                    <ul>
                    <%
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title_en from tol_co where lm=2 order by px desc,id desc"
	rs.open sql,conn,1,1
	while not rs.eof
%>
...
%>
        ...
        <div id="right">
            <div id="right_pr_title">
                <h2><%=title%></h2>
                <span>Your location：Home > Services > <%=title%></span>
                <div class="clear"></div>
            </div>
            <div id="right_pr_co">
            <%=z_body%>
