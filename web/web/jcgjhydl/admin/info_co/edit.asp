...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg" >           
     <td width="120" align="right"><strong>中文标题：</strong></td>          
<td ><input name="title" type="text" id="title"  size="44" maxlength="150" value="<%=title%>">              
      ...
      <tr>
    <td width="120"  align="right" class="tdbg"><strong>英文标题：</strong></td>
    <td class="tdbg"><input name="title_en" type="text" id="title_en" size="44" maxlength="150" value="<%=title_en%>"></td>
  </tr>
...
(英文) </p></td>
    ...
    <tr class="tdbg" id="dis_z_body"  <%if dis_z_body="no"  then response.write"style='display:none;'" end if%>>          
        <td width="120" align="right" valign="middle"><p><strong>中文内容：<br></strong><br></td>
    <td >
    ...
    %>	<%
    Dim oFCKeditor_en
    Set oFCKeditor_en = New FCKeditor
    oFCKeditor_en.Config("LinkBrowser") = "true" 
    oFCKeditor_en.Config("ImageBrowser") = "true" 
    oFCKeditor_en.Config("FlashBrowser") = "true" 
    oFCKeditor_en.Config("LinkUpload") = "true" 
    oFCKeditor_en.Config("ImageUpload") = "true" 
    oFCKeditor_en.Config("FlashUpload") = "true" 
    oFCKeditor_en.Value = z_body_en
    oFCKeditor_en.Create "z_body_en"
    %>(英文)</td>        
    </tr>
