...
<td ><input name="title" type="text" id="title"  size="44" maxlength="150">              
                ...
                <tr class="tdbg">
                <td width="120" align="right"><strong>英文标题：</strong></td>
                <td ><input name="title_en" type="text" id="title_en" size="44" maxlength="150">           	</td>
          </tr>
    ...
    <tr class="tdbg"  id="dis_f_body" style="display:none;">
        ...
        <p>
          <textarea name="f_body_en" cols="72" rows="4" id="f_body_en"></textarea>
          (英文)
</p></td>
    </tr>
