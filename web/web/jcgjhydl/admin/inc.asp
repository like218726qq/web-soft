...
<%  Session.CodePage=65001
	...
	sub listpage_num(pra)
		htm = ""
		if pageno>1 then
			htm = htm & "<a href=""?page="&pageno-1&pra&""" > 上一页 </a></li>"
		else
			htm = htm & "上一页"
		end if
		...
		p_end = pageno + step2
		s_str = "<a href=""?page=1"&pra&"""> 1... </a>"
		e_str = "<a href=""?page="&pagezong&pra&"""> ..."&pagezong&" </a>"
		...
		for i = p_start to p_end
			if i = pageno then
				htm = htm & "<font style='color:#CC0000'> "&i&" </font>"
			else
				htm = htm & "<a href=""?page="&i&pra&"""> "&i&" </a>"
			end if
		next
		htm = htm & e_str
		
			if pageno<>pagezong then
				htm = htm &"<a href=""?page="&pageno+1&pra&"""> 下一页 </a>"
			else
				htm = htm &"下一页"
			end if
		htm = htm &""
	...
	sub listpage_num_en(pra)
		htm = ""
		if pageno>1 then
			htm = htm & "<a href=""?page="&pageno-1&pra&""" > Previous Page </a></li>"
		else
			htm = htm & "Previous Page"
		end if
		...
		htm = htm & e_str
			...
			if pageno<>pagezong then
				htm = htm &"<a href=""?page="&pageno+1&pra&"""> Next Page </a>"
			else
				htm = htm &"Next Page"
			end if
		htm = htm &""
