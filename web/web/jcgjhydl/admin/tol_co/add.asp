...
<table width="100%"  border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr>
    <td width="120" align="right" class="tdbg"><strong>标　　题(英文)：</strong></td>
    <td class="tdbg"><input name="title_en" type="text" id="title" size="30" maxlength="150"></td>
  </tr>
   <tr>
   ...
   <tr>
    <td width="120" align="right" class="tdbg"><strong>内　　容(英文)：</strong></td>
    <td class="tdbg">
    <%
    oFCKeditor.Value = ""
