...
<form method="POST" name="form1" action="addd.asp" onSubmit="return check()" >
		...
		<tr class="tdbg">
          ...
          <td>
                ...
                while not rsa.eof 	
                    ...
                    if rsa("add_xx")="yes" then
                        ...
                        response.write"<OPTION value='no'>• "&rsa("title_lm")&"&nbsp;"&rsa("title_lm_bl")&"×</OPTION>"&chr(10)
                    end if
          ...
          <tr class="tdbg">
                ...
                <td ><input name="title" type="text" id="title" size="30" maxlength="150">
                  <!--<input name="title_bl" type="text" id="title_bl" size="30" maxlength="150" />
    ...
    <input name="pro_danwei" type="text" id="pro_danwei" maxlength="50">
        <!--<input name="pro_danwei_bl" type="text" id="pro_danwei_bl" maxlength="50" />
        (西班牙语)　
        </strong>-->
...
<td class="tdbg" ><input name="pro_color" type="text" id="pro_color" maxlength="50"><!--<input name="pro_color_bl" type="text" id="pro_color_bl" maxlength="50" />
<strong>(西班牙语)</strong>--></td>
</tr>        
<tr class="tdbg2">
<td width="120" align="right" class="tdbg"><strong>产品价格：</strong></td>
<td class="tdbg" ><strong>
        <input name="pro_guige" type="text" id="pro_guige" maxlength="50">
        <!--<input name="pro_guige_bl" type="text" id="pro_guige_bl" maxlength="50" />
        (西班牙语)</strong>--></td>
          </tr>
