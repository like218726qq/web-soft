...
if rs.eof then 
	...
	lm=rs("lm")
	title=rs("title")
	title_bl=rs("title_bl")
	pro_danwei=rs("pro_danwei")
	pro_guige=rs("pro_guige")
	pro_color=rs("pro_color")
	pro_money=rs("pro_money")
		pro_danwei_bl=rs("pro_danwei_bl")
	pro_guige_bl=rs("pro_guige_bl")
	pro_color_bl=rs("pro_color_bl")
	pro_money_bl=rs("pro_money_bl")
	f_body=rehtml(rs("f_body"))
	z_body=rs("z_body")
	z_body_bl=rs("z_body_bl")
	img_sl=rs("img_sl")
	px=rs("px")
end if
rs.close
      ...
      <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
            ...
            <select name="lm">
                ...
                while not rsa.eof 	
					...
					if rsa("add_xx")="yes" then
						response.write"<OPTION value='"&rsa("id_lm")&"' >• "&rsa("title_lm")&"&nbsp;"&rsa("title_lm_bl")&"</OPTION>"&chr(10)
                ...
                while not rsb.eof
					if rsb("add_xx")="yes" then
						response.write("<option value="&rsb("id_lm")&">"&i&" 　|—"&rsb("title_lm")&"&nbsp;"&rsb("title_lm_bl")&"</option>")&chr(10)
					elseif add_xx="no" then
						response.write("<option value="&rsb("id_lm")&">"&i&" 　|—"&rsb("title_lm")&"&nbsp;"&rsb("title_lm_bl")&"</option>")&chr(10)
					else
						response.write("<option value='no'>"&i&" 　|—"&rsb("title_lm")&"&nbsp;"&rsb("title_lm_bl")&"×</option>")&chr(10)
					end if
          ...
          <tr class="tdbg">
            ...
            <td ><input name="title" type="text" id="title" value="<%=title%>" size="30" maxlength="150">
            <!--<input name="title_bl" type="text" id="title_bl" value="<%=title_bl%>" size="30" maxlength="150" />
            <strong>(西班牙语)</strong>--></td>
          </tr>
     
		  <tr class="tdbg2">
                <td width="120" align="right" class="tdbg"><strong>产品编号：</strong></td>
        <td class="tdbg">               
    <input name="pro_danwei" type="text" id="pro_danwei" maxlength="50" value="<%=pro_danwei%>">
                <strong>
                <!--<input name="pro_danwei_bl" type="text" id="pro_danwei_bl" value="<%=pro_danwei_bl%>" maxlength="50" />
(西班牙语)</strong>-->　产品型号：
...
<td class="tdbg"><input name="pro_color" type="text" id="pro_color" maxlength="50" value="<%=pro_color%>"><!--<input name="pro_color_bl" type="text" id="pro_color_bl" value="<%=pro_color_bl%>" maxlength="50" />
                <strong>(西班牙语)</strong> --></td>
</tr>
<tr class="tdbg2">
<td width="120" align="right" class="tdbg"><strong>产品价格：</strong></td>
      <td class="tdbg" ><input name="pro_guige" type="text" id="pro_guige" maxlength="50" value="<%=pro_guige%>">
        <!--<input name="pro_guige_bl" type="text" id="pro_guige_bl" maxlength="50" value="<%=pro_guige_bl%>" />
        <strong> (西班牙语)</strong>　--></td>
        </tr>
