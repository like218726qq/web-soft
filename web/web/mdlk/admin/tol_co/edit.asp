...
<table width="100%"  border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr>
    <td width="190" align="right" class="tdbg"><strong>所属栏目：</strong></td>
    <td width="1107" class="tdbg"> 
	   <select name="lm" >
    ...
    <tr>
    <td width="190"  align="right" class="tdbg"><strong>标　　题：</strong></td>
    <td class="tdbg"><input name="title" type="text" id="title" size="30" maxlength="150" value="<%=title%>"></td>
  </tr>
<!--   <tr>
    <td width="190"  align="right" class="tdbg"><strong>标　　题(西班牙语)：</strong></td>
    <td class="tdbg"><input name="title_bl" type="text" id="title_bl" size="30" maxlength="150" value="<%=title_bl%>"></td>
  </tr>-->
   <tr>
    <td width="190" align="right" class="tdbg"><strong>内　　容：</strong></td>
    <td class="tdbg">
...
<!--  <tr>
    <td width="190" align="right" class="tdbg"><strong>内　　容(西班牙语)：</strong></td>
    <td class="tdbg">
    <%
...
<tr class="tdbg">
    <td width="190" align="right"><STRONG>显示顺序：</STRONG></td>
