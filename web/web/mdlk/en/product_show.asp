...
%>
    ...
    <div id="indRight">
      <div id="indPro">
        	<p class="nindProTitle">产品展示　<%=dao%></p>
...
<tr>
            ...
            <td width="114" height="22" align="right" bgcolor="#CCCCCC"><strong>Product Name:</strong></td>
            <td width="176" bgcolor="#F7F7F7">&nbsp;<%=title%></td>
          </tr>
                    <tr>
                      <td height="19" align="right" bgcolor="#CCCCCC"><strong>Procuct No:</strong></td>
                      <td bgcolor="#F7F7F7">&nbsp;<%=pro_danwei%></td>
                    </tr>
                                        <tr>
                      <td height="19" align="right" bgcolor="#CCCCCC"><strong>Procuct Model:</strong></td>
                      <td bgcolor="#F7F7F7">&nbsp;<%=pro_color%></td>
                    </tr>
                    <tr>
                      <td height="19" align="right" bgcolor="#CCCCCC"><strong>Price:</strong></td>
                      <td bgcolor="#F7F7F7">&nbsp;<%=pro_guige%></td>
                    </tr>
                    <tr>
                      <td align="right" bgcolor="#CCCCCC"><strong>More Information:</strong></td>
                      <td bgcolor="#F7F7F7">&nbsp;<%=f_body%></td>
                    </tr>
			        <tr>
                      <td height="19" align="right" bgcolor="#CCCCCC"><strong>&nbsp;View Count</strong></td>
                      <td bgcolor="#F7F7F7">&nbsp;<%=read_num%></td>
                    </tr>
                    <tr bgcolor="D1E9A4">
                      <td height="30" colspan="3" bgcolor="#CCCCCC"><strong>&nbsp;Detail:</strong></td>
          </tr>
