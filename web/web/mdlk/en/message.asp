...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <form name="form1" method="post" action="message_add.asp" onsubmit="return check()">
    <tr>
	  <td width="18%" height="25" align="right">标题： </td>
...
<input name="address" type="text" id="address" maxlength="50" class="lyb_bor lyb_inp" /></td>
	...
	<tr>
	  ...
	  <td><input name="submit" type="submit" id="submit2" value=" 提交 " class="lyb_bor lyb_btn" />
		  　<input type="reset" name="Submit" value=" 重置 " class="lyb_bor lyb_btn" /></td>
	</tr>
	</form>
</table>
</div>
