...
%>
            	...
            	</tr></table></span><span class="nindPorName"><a href="product_show.asp?id=<%=rs("id")%>"><%=rs("title")%></a></span></li>
     <%
		a=a+1
		rs.movenext
		wend
...
%>  
       ...
       <div class="clear"></div>
<div class="page"><%if pagenum<>"" then call listpage_21(pra) end if%></div>
        </div>
    </div>
    <div class="clear"></div>
</div>
