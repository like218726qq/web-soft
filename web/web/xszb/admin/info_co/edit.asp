...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg" >           
     ...
     <tr class="tdbg" >           
     <td width="120" align="right"><strong>信息标题（英文）：</strong></td>          
      <td ><input name="title_en" type="text" id="title_en"  size="44" maxlength="150" value="<%=title_en%>">              
       </td >
    </tr>
