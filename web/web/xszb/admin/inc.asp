...
<%  Session.CodePage=65001
	...
	sub listpage(key)
		...
		listp=listp&"<TD >第<font color='#666666'>"&pageno&"</font>页|共<font color='#666666'>"&pagezong&"</font>页|<font color='#666666'>"&pagenum&"</font>项/页|共<font color='#666666'>"&counter&"</font>项</td>"&chr(10)
	...
	sub listpage_num(pra)
		...
		if pageno>1 then
			...
			htm = htm & "<li class=""nolink"">Previous</li>"
		end if
		...
		htm = htm & e_str
			...
			if pageno<>pagezong then
				...
				htm = htm &"<li class=""nolink"">Next</li>"
			end if
