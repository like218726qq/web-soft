...
<TABLE class=border cellSpacing=1 cellPadding=2 width="100%" border=0>
    <TBODY>
      <TR class=title >
        ...
        <TD align=center><strong>修改</strong>|<strong>推荐</strong>| <strong>新品</strong>|<strong>屏蔽</strong>| <strong>删除</strong></TD>
      </TR>
        <%
    ...
    <TR class=tdbg onMouseOver="DoHL();" onMouseOut="DoLL();" onClick="DoSL();">
        ...
        <%else%>
        <A href="make.asp?ac=hot2&id=<%=rs("id")%>">新品</A>|
        <%end if%>
