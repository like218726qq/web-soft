...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <div class="title01">
    	<div style=" margin:8px 0 10px 5px; color:#d19231;">Product page</div>
...
<table width="190" border="0" cellspacing="0" cellpadding="0" class="pro_box">
  <tr>
    <td align="center" height="210"><div class="pro_img"><a href="product_show.asp?id=<%=rs("id")%>"><img src="../<%=rs("img_sl")%>"    width="160" height="160"/></a></div></td>
  </tr>
  <tr>
    <td align="center" height="50" valign="middle"><a href="product_show.asp?id=<%=rs("id")%>"><%=rs("title_en")%></a></td>
  </tr>
</table>
<%
