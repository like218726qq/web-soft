...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" valign="top"><table width="810" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30" style="padding-left:20px; color:#d19231;"><div class="nei_bigclass" >资料下载</div></td>
      </tr>
      <tr>
	...
	sql="select id,title,wtime,z_body,img_sl,dow_sl from info_co where pass='yes' and lm=30 order by px desc,id desc"
...
%>
                <table width="170" border="0" cellspacing="0" cellpadding="0" class="down_tab">
                  <tr>
                    <td align="center"><a href="../<%=rs("dow_sl")%>" class="down_title"><%=rs("title")%></a></td>
                  </tr>
                  <tr>
