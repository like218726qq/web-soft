...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" valign="top"><table width="810" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30" style="padding-left:20px; color:#d19231;"><div class="nei_bigclass" >产品展示</div></td>
      </tr>
      <tr>
  ...
  <tr>
    ...
    <a href="../<%=getbpic(img_sl,"d")%>" class="MagicZoom" rel="zoom-width: 233px; zoom-height: 300px; zoom-position: right;"><img src="../<%=getbpic(img_sl,"d")%>" onload="if (this.width>350){this.height=400*this.height/this.width;this.width=350;}"/></a>
<img class="MagicZoomLoading" src="images/ajax-loader.gif" alt="Loading Zoom, please wait"/></div></td>
    <td width="400" valign="top"><div style="margin-left:25px; line-height:25px; margin-top:30px; width:375px; overflow:hidden;"><%=z_body%></div></td>
  </tr>
</table>
</div>
          </td>
