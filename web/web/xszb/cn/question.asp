...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" valign="top"><table width="810" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30" style="padding-left:20px; color:#d19231;"><div class="nei_bigclass">答疑解惑</div></td>
      </tr>
      <tr>
	...
	sql="select id,title,wtime,z_body from info_co where pass='yes' and lm=31 order by px desc,id desc"
...
%>
  ...
  <tr>
    ...
    <td width="532"><a href="question_show.asp?id=<%=rs("id")%>"><%=rs("title")%></a></td>
