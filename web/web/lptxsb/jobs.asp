...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="46" align="center" valign="bottom" style=" background:url(images/neiye-k_11.jpg) left no-repeat "><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="726" align="left" valign="middle" style="padding-right:30px;"><span style=" float:right">您所在的位置：首页 > 人才招聘 > <%=title%></span>
  ...
  <tr>
	...
	while not rs.eof
%>
            	<li><a href="jobs.asp?id=<%=rs("id")%>"<%if id=rs("id") then%> class="bgdw"<%end if%>><%=rs("title")%></a></li>
          <%
    rs.movenext
	wend
	rs.close
