	    ...
	    <a href="#" onfocus="menu_drop('menu','block');" class="quick-a w_finder_h" ga="love/current16/neck/quick">快速导航</a>
	     <div id="menu">
		      <div id="menu-link">
					...
					<a id="link_network" href="service.asp?id=7" onClick="stat(this);">售后网点</a>
					<a id="link_faq" href="service.asp?id=14" onClick="stat(this);">常见问题</a>
					<a id="link_glossary" href="service.asp" onClick="stat(this);">专业词汇表</a>
					<a id="link_service" href="service.asp?id=9" onClick="stat(this);">服务政策</a>
					...
					<a id="link_cumpus" href="jobs.asp" target="_blank" onClick="stat(this);" >OPPO人才招聘</a>			</div>
			<div id="menu_bg"></div>
	    </div>
	</div></td>
            <td width="306"></td>
            ...
            <td width="253"  style="background:url(images/dh-_08.png) left no-repeat;"><table width="249" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="52" height="25" align="center" valign="middle">
                  <input type="submit" name="button" style=" background-image:url(images/btn.jpg); width:26px; height:21px; cursor:pointer" id="button" value="　" />
                </td></form>
              </tr>
            </table></td>
          </tr>
