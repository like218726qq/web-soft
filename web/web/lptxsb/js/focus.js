...
function focus_show(id)
{
	if(focus_time < 20 && focus_bg != "")
	{
		...
		if(!focus_begin)
		{
			document.getElementById("focus_bg").style.backgroundImage= "url('" + focus_bg + "')";
			focus_time = 0;
		...
		document.getElementById("focus_show").innerHTML = "<a href='" + focus_url + "' target='_blank' title='" + focus_title + "' style='background:url(" + arr[0] + ") center no-repeat;'></a>";
		focus_url = arr[1];
		focus_title = arr[2];
		focus_id ++;
