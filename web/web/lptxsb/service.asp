...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="46" align="center" valign="bottom" style=" background:url(images/neiye-k_11.jpg) left no-repeat "><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="726" align="left" valign="middle" style="padding-right:30px;"><span style=" float:right">您所在的位置：首页 > 服务支持 > <%=title%></span>
              <span class="STYLE8">服务支持</span></td>
          </tr>
            <tr><td colspan="2" align="left" class="line"><img src="images/neiye-zx_33.jpg" width="780" height="1" /></td>
            </tr>
        </table></td>
          </tr>
        </table></td>
  ...
  <tr>
	...
	while not rs.eof
%>
            	<li><a href="service.asp?id=<%=rs("id")%>"<%if id=rs("id") then%> class="bgdw"<%end if%>><%=rs("title")%></a></li>
          <%
    rs.movenext
	wend
	rs.close
