   ...
   <div class="main_left">
       <div class="mle_par1">
          <div class="mle_title">
             ...
             <ul>
                <li class="oms">个人账号管理 My Account</li>
             </ul>
          </div>
          <div class="clear"></div>
          <div class="mle_cont">
             ...
             <div class="xylb2_1">
             	<table border="0" cellpadding="0" cellspacing="0" width="705" height="540">
                	<tr>
					    ...
					    <tr>
									  <th align="right" bgcolor="#FFFFFF" class="bg3">姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名 Gender：</th>
									    <td width="174" bgcolor="#FFFFFF" class="title_bg"><span class="fon"><%=rs("rename")%></span></td>
                       	  <th width="84" align="right" bgcolor="#FFFFFF" class="bg3">性别 Sex：</th>
                          <td width="173" bgcolor="#FFFFFF" class="title_bg"><span class="fon"><%=rs("xingbie")%></span></td>
							 	    </tr>
									<tr>
									  <th  align="right" width="219" bgcolor="#FFFFFF"  class="bg3">联系电话 Contact No. ： </th>
									  <td colspan="3" bgcolor="#FFFFFF" class="title_bg"><%=rs("phone")%>&nbsp;</td>
									  </tr>
									<tr>
									  <th align="right" bgcolor="#FFFFFF" class="bg3">邮箱地址 E-mail Address： </th>
									...
									<tr>-->
									  <th align="right" bgcolor="#FFFFFF" class="bg3">传真号码 Fax No. ： </th>
									  <td colspan="3" bgcolor="#FFFFFF"  class="title_bg"><%=rs("fax")%>&nbsp;</td>
									  </tr>
						
											  <tr>
									  <th align="right" bgcolor="#FFFFFF" class="bg3">邮编地址 Postcode： </th>
									  <td colspan="3" bgcolor="#FFFFFF"  class="title_bg"><%=rs("post")%>&nbsp;</td>
									  </tr>
						
									<tr>
									  
									  <th align="right" bgcolor="#FFFFFF" class="bg3">联系地址 Address： </th>
