...
sql="select * from order_lm where id_lm="&id&""
...
<INPUT name="id" type="hidden" value="<%=id%>">
  ...
  <TD>
			...
			<SELECT name="fid">
				...
				sql="select * from order_lm where fid=0 and xia='yes' order by px desc,id_lm desc"
				...
				sql="select * from order_lm where fid="&fid&" and xia='yes' order by px desc,id_lm desc"
