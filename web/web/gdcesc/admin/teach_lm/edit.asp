    ...
    <TR class='tdbg'>
		...
		<TD>
			...
			<SELECT name='fid'>
				...
				sql="select id_lm,title_lm,xia from teach_lm where fid=0 and xia='yes' order by px desc,id_lm desc"
				...
				sub addlm(fid,i)
					...
					sql="select id_lm,title_lm,xia from teach_lm where fid="&fid&" and xia='yes' order by px desc,id_lm desc"
