...
<table width="100%"  border="0" cellpadding="2" cellspacing="1" class="border">
  <tr align="center" class="title">
	...
	sql="select id_lm,title_lm,add_xx,xia,px from teach_lm where fid=0 order by px desc,id_lm desc"
...
<%
	...
	sub deflm(fid,i)
		...
		sql="select id_lm,title_lm,add_xx,xia,px from teach_lm where fid="&fid&" order by px desc,id_lm desc"
