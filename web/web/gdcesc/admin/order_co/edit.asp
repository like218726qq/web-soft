...
'获取该信息所在分类是否可添加信息
set rs=server.CreateObject("adodb.recordset")
sql="select add_xx from order_lm where id_lm="&lm&""
rs.open sql,conn,1,1
if rs.eof then
      ...
      <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
          ...
          <tr class="tdbg">
            ...
            <tr class="tdbg2">
            <td width="120" align="right" class="tdbg"><strong>次    数：</strong></td>
                  <td class="tdbg" ><input name="pro_guige" type="text" id="pro_guige" maxlength="50" value="<%=pro_guige%>"> 次　
                     价    格：
                  <input name="pro_money" type="text" id="pro_money" maxlength="50" value="<%=pro_money%>">元              </td>
        </tr>
              <tr class="tdbg">
