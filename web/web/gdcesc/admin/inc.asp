...
<%  Session.CodePage=65001
	...
	function send_z(zt)
		send_z=""
		if zt="no" then
			send_z="<font color=""blue"">未授课</font>"
		elseif zt="yes" then
			send_z="<font color=""#ccc"">已授课</font>"
		end if
	end function 
	...
	function send_z1(zt)
		send_z1=""
		if zt="no" then
			send_z1="<font color=""blue"">未修改</font>"
		elseif zt="yes" then
			send_z1="<font color=""#666"">已修改</font>"
		end if
	end function 
	...
	function order_z(zt)
		if zt="nno" then
			order_z="<font color=""blue"">未确认</font>"
		elseif zt="no" then
			order_z="<font color=""red"">已取消</font>"
		elseif zt="yes" then
			order_z="<font color=""#666"">已确认</font>"
		end if
	end function
	
	function pay_z(zt)
		if zt="no" then
			pay_z="<font color=""blue"">未付款</font>"
		elseif zt="yes" then
			pay_z="<font color=""#666"">已付款</font>"
		end if
	end function
	
	function send_ztt(zt)
		if zt="no" then
			send_ztt="<font color=""blue"">未完成</font>"
		elseif zt="yes" then
			send_ztt="<font color=""#666"">已完成</font>"
		end if
	end function
	...
	function py(zt)
		py=""
		if zt="no" then
			py="<font color=""blue"">未评语</font>"
		elseif zt="yes" then
			py="<font color=""#666"">已评语</font>"
		end if
	end function 
	...
	function formatnum(num)
		if num<>"" then
			formatnum=formatnumber(num,2,-1,0,0)
		end if
	end function
	...
	function formatdate1(str)
		if str<>"" then
			formatdate1=year(str)&"."&right("0"&month(str),2)&"."&right("0"&day(str),2)
		end if
	end function
