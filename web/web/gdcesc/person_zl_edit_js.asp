...
if act="post" then
	...
	rs.close
	set rs=nothing
	call msg("修改成功","location=""person_zl_edit_js.asp""")
end if%>
                    	...
                    	<td valign="top">
                             <%
							  ...
							  %>
								...
								<FORM id=zlfrm name=zlfrm onSubmit="return checkForm('zlfrm')" action=person_zl_edit_js.asp?act=post method=post>
									<tr>
									<td class="reg_ti">
