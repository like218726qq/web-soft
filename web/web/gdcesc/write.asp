                       ...
                       <td valign="top">
                       		<table border="0" cellpadding="0" align="center" width="680" class="read">
                            	 <%
									...
									sql="select * from pro_order_xz where person_xs='"&session("person")&"'  order by id desc"
							   ...
							   <tr>
								 ...
								 <td  align="left" valign="middle" style="border-bottom:dashed 1px #ccc; padding-left:5px;"><a href="write_show.asp?id=<%=rs("id")%>" ><%=getstr(rs("title"),85)%></a> </td>
