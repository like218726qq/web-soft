                	...
                	<tr>
                    	<td valign="top">
                          <%
								...
								sql="select id,title,color_font,wtime from info_co where lm=32 and pass='yes' order by px desc,id desc"
						   ...
						   <tr>				
							  ...
							  <td width="605" align="left" valign="middle" style="border-bottom:dotted 1px #ccc; padding-left:5px;">
								<a href="eng_ls_show.asp?id=<%=rs("id")%>"><font style="color:<%=rs("color_font")%>;"><%=rs("title")%></font></a>									   </td>
