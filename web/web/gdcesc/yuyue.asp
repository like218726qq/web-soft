...
function check(){
	...
	var person_jsj=document.form1.person_jsj;
...
function getbody(ty){
	...
	if (ajaxHttp!=null) {
		...
		ajaxHttp.open("GET", "leixing.asp?id="+ty+"&r="+Math.random() ,true);
		ajaxHttp.setRequestHeader("Content-Type", "text/html;charset=utf-8");
		ajaxHttp.send(null);
	}
}
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" >
                                <tr>
                                	<td style="padding:20px 0 10px 20px;" valign="top">
                                    	<table  cellpadding="0" cellspacing="0" width="680" style="border-collapse:inherit; border:1px solid #999999;" >
                                        ...
                                        <input  name="send_xs" type="hidden" value="no" />
                                        	<tr>
                                            	<td style="color:#666; font-size:16px; background-color:#eaeaea;  width:100px;border-bottom:1px solid #999999;border-right:1px solid #999999;">预约时间：</td>
                                        	...
                                        	<tr>
                                            	<td style="color:#666; font-size:16px; background-color:#eaeaea;  width:100px;border-bottom:1px solid #999999;border-right:1px solid #999999;">选择老师：</td>
                                                <td style="padding:2px 0 2px 8px; height:26px;border-bottom:1px solid #999999; width:580px;">
                                                <select name="person_jsj">
                                                    <option value="" selected>请选择教师</option>
                                                     <%
                                                        '连接数据库
                                                        
                                                        set rs1=server.CreateObject("adodb.recordset")
                                                         sql="select * from info_co where lm=50 "
                                        	...
                                        	<tr>
                                            	<td style="color:#666; font-size:16px; background-color:#eaeaea;  width:120px;border-bottom:1px solid #999999;border-right:1px solid #999999;">选择课题栏目：</td>
                                                <td style="padding:2px 0 2px 8px; height:26px;border-bottom:1px solid #999999; ">
                                                 
                                              <select name="title_lm" id="title_lm" onchange="getlun(this.value)">
                                         		<option value="" selected>选择课题栏目</option>
													<%
                                                        set rs_v=server.CreateObject("adodb.recordset")
                                                        sql_v="select * from info_lm_xz where fid=3 order by px desc,id_lm desc"
                                                        rs_v.open sql_v,conn,1,1
                                                        while not rs_v.eof
                                                    %>
                                                    <option value="<%=rs_v("id_lm")%>"><%=rs_v("title_lm")%></option>
                                                    <%
                                                        rs_v.movenext
                                                        wend
                                                        rs_v.close
                                        	...
                                        	<tr>
                                            	<td style="color:#666; height:26px; font-size:16px; background-color:#eaeaea; width:100px;border-bottom:1px solid #999999;border-right:1px solid #999999;">选择课题：</td>
                                                <td style="padding:2px 0 2px 8px;border-bottom:1px solid #999999; width:580px;">
                                                   <div id="dis_zm" >
                                                    <select name="title" id="title" onchange="getbody(this.value)">
                                                        <option value="" selected>选择课题</option>
                                                    </select>
                                                    </div>
                                                </td>
                                            </tr>
                                        	<tr>
                                            	<td style="color:#666; height:26px; font-size:16px; background-color:#eaeaea; width:100px;border-bottom:1px solid #999999;border-right:1px solid #999999;"></td>
                                                <td style="padding:2px 0 2px 8px;border-bottom:1px solid #999999; width:550px; height:200px; font-family:'Times New Roman';" valign="top">
                                                   <div  id="dis_teacher" style="width:550px;" >
