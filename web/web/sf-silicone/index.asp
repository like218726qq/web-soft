...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="1006" valign="top" bgcolor="#FFFFFF"><table width="1006" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="100%" height="20" class="font4">
        <ul id="limrq" style="overflow:hidden;height:20px;line-height:20px;">
           <%
		       set rs=server.CreateObject("adodb.recordset")
			   sql="select id,title,wtime from info_co where lm=8 and pass='yes' and tuijian='yes' order by px,id desc"
          ...
          <td background="images/bk_zhong.jpg" style="padding-left:19px; padding-top:4px;"><table width="955" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="290" valign="top"><table width="290" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="24" background="images/news.jpg" class="news_font1">NEW PRODUCTS
                ...
                <tr>
                  <td valign="top" style="padding-top:20px;">
                   <%
					   set rs=server.CreateObject("adodb.recordset")
					   sql="select top 1 id,title,img_sl,z_body from pro_co where pass='yes' and tuijian='yes' and hot='yes' order by px,id desc"
					   rs.open sql,conn,1,1
					   if not rs.eof then
					   while not rs.eof
				   %>
                    <a href="product_show.asp?id=<%=rs("id")%>">
                  <img src="<%=getbpic(rs("img_sl"),"d")%>" width="135" height="135" class="ima" /></a>
                  <span class="news_font">
                  <a href="product_show.asp?id=<%=rs("id")%>">
                  <%=left(rehtml(rs("z_body")),240)&"..."%>
                  </a></span><span class="news_font1"><a href="product_show.asp?id=<%=rs("id")%>">more+</a></span>
                   <%
			   rs.movenext 
			   wend
			   end if
			...
			%>
              ...
              <td width="613" valign="top" style="padding-top:14px;"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                 <%	
					set rs=server.CreateObject("adodb.recordset")
					sql="select top 3 id,title,img_sl from pro_co where pass='yes' and tuijian='yes' order by px desc,id desc"
					rs.open sql,conn,1,1
					if not rs.eof then
					a=1
					while not rs.eof 
				%>
                  ...
                  <td  align="center" width="210px"><table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="ind_img" valign="middle" align="center">
                      <a href="product_show.asp?id=<%=rs("id")%>" title="<%=rs("title")%>">
                      <img src="<%=rs("img_sl")%>" /></a></td>
                    </tr>
                    <tr>
                      <td height="40" align="center" class="news_font1">
                      <a href="product_show.asp?id=<%=rs("id")%>"><%=rs("title")%></a></td>
                    </tr>
                  </table></td>
                  <%
					a=a+1
        ...
        <td background="images/bk_zhong.jpg" style="padding-top:6px; padding-left:19px; padding-bottom:8px;"><table width="954" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="424" valign="top"><table width="424" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="24" background="images/about.jpg" class="news_font1">ABOUT US<span style=" margin-top:3px; margin-right:5px; float:right">
                  <a href="about.asp"><img src="images/jiahao.jpg" title="查看更多..."/></a></span>                </td>
              </tr>
              <tr>
                <td valign="top" class="news_font" style="padding-top:24px;">
                  <%
				   set rs=server.CreateObject("adodb.recordset")
				   sql="select z_body,img_sl from tol_co where id=11" 
				   rs.open sql,conn,1,1
				   if not rs.eof then
				 %>
                <span class="news_font" style="padding-top:24px;">
                <img src="<%=rs("img_sl")%>" width="215" height="112" class="ima1" /></span>
                 <%=left(rehtml(rs("z_body")),420)&"..."%>
...
<%
            ...
            <td width="210" valign="top"><table width="210" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="24" background="images/product.jpg" class="news_font1">CASE<span style=" margin-top:3px; margin-right:5px; float:right">
                  <a href="case.asp"><img src="images/jiahao.jpg" title="查看更多..."/></a></span>
                </td>
              </tr>
              <tr>
                ...
                <%
				    set rs=server.CreateObject("adodb.recordset")
					sql="select top 1 img_sl from info_co where lm=10 and pass='yes' and tuijian='yes'"
					rs.open sql,conn,1,1
					if not rs.eof then
				%>
            ...
            <td width="232" valign="top"><table width="232" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="24" background="images/cantact.jpg" class="news_font1">CONTACT US<span style=" margin-top:3px; margin-right:5px; float:right">
                  <a href="contact.asp"><img src="images/jiahao.jpg" title="查看更多..."/></a></span>                </td>
              </tr>
              <tr>
                <td height="24">&nbsp;</td>
              </tr>
              <tr>
                <td>
                  <%
				   set rs=server.CreateObject("adodb.recordset")
				   sql="select img_sl from tol_co where id=12" 
				   rs.open sql,conn,1,1
				   if not rs.eof then
				 %>
              ...
              <tr>
                <td class="news_font" style="padding-top:5px; padding-left:3px;">
                 <%
				   set rs=server.CreateObject("adodb.recordset")
				   sql="select z_body from tol_co where id=12" 
				   rs.open sql,conn,1,1
				   if not rs.eof then
