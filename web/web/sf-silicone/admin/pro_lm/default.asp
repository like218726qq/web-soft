...
<TABLE class=border cellSpacing=1 cellPadding=2 width="100%" align=center border=0>
  ...
  <TR class=tdbg onMouseOver="DoHL();" onMouseOut="DoLL();" onClick="DoSL();">
	  ...
	  <TD><IMG height=15 src='../images/tree_folder4.gif' width=15 valign='abvmiddle'><A href='edit.asp?id=<%=rsa("id_lm")%>'><STRONG><%=rsa("title_lm")%>&nbsp;&nbsp;<span style="color:ff0000"><%=rsa("title_lm_en")%></span>&nbsp;&nbsp;<span style="color:ffcc00"><%=rsa("title_lm_es")%></span></STRONG></A>&nbsp;<%=rsa("id_lm")%>&nbsp;<%=zt%></TD>
