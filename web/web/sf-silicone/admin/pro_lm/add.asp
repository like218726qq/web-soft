 ...
 <TABLE width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  ...
  <TD>
	...
	<TR class="tdbg">
		...
		<TD>
			<INPUT name="title_lm_es" type="text" id="title_lm_es" size="30" maxlength="150">
		  <FONT color=red>*</FONT>
		</TD>
	</TR>
   <!-- <tr class="tdbg">
    ...
    <tr class="tdbg">
                ...
                <td>
				  <textarea name="f_body_es" cols="72" rows="4" id="f_body_es"></textarea>				</td>
          </tr>
    <TR class="tdbg">
