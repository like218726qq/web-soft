    ...
    <tr class="title">
     ...
     <tr class="tdbg">
      <td width="120" align="right"><strong>语言类型：</strong></td>          
        <td >
        <input type="radio" name="language" id="language1"  value="yes" checked="checked"/>英文版
        &nbsp;<input type="radio" name="language" id="language2"  value="no"/>日文版
        &nbsp;<input type="radio" name="language" id="language3"  value="xi"/>西班牙文版
        </td>
    </tr>  
    <tr class="tdbg">
