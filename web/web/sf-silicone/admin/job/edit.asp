...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    <tr class="title">
     ...
     <tr class="tdbg">
      <td width="120" align="right"><strong>语言类型：</strong></td>          
        <td >
        <input type="radio" name="language" id="language1"  value="yes" <%if language="yes" then%>checked="checked"<%end if%>/>英文版
        &nbsp;<input type="radio" name="language" id="language2"  value="no" <%if language="no" then%>checked="checked"<%end if%>/>日文版
         &nbsp;<input type="radio" name="language" id="language3"  value="no" <%if language="yn" then%>checked="checked"<%end if%>/>西班牙文版
        </td>
    </tr>  
    <tr class="tdbg">
