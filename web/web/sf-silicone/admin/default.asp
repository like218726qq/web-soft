    ...
    <form action="admin_login.asp" method="post" name="form1" target="theblank">
      <table width="250" border="0" align="center" cellspacing="8">
        <tr>
          ...
          <td width="164"><input name="username" type="text" class="username" size="25" maxlength="50" value="admin"></td>
        </tr>
        <tr>
          <td align="right">密　码：</td>
          <td><input name="password" type="password" class="password" size="25" maxlength="50" value="4006993811"></td>
        </tr>
        <tr>
