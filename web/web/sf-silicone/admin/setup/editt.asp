...
site_title_es=html(request.Form("site_title_es"))
site_key_es=html(request.Form("site_key_es"))
site_des_es=html(request.Form("site_des_es"))
site_bot_es=request.Form("site_bot_es")
...
rs.open sql,conn,1,3
	rs("site_title")=site_title_es
	rs("site_key")=site_key_es
	rs("site_des")=site_des_es
	rs("site_bot")=site_bot_es
rs.update()
rs.close()
set rs=nothing
