...
<input  type="hidden" name="w_url" value="<%=w_url%>">
     ...
     <tr class="tdbg">
            ...
            <td ><input name="title_es" type="text" id="title_es" value="<%=title_es%>" size="30" maxlength="150"></td>
          </tr>
          
           <tr class="tdbg2" >
            <td width="120" align="right" class="tdbg"><strong>图片alt值：</strong></td>
        <td class="tdbg"><strong>                
    <input name="pro_guige" type="text" id="pro_guige" maxlength="60" value="<%=pro_guige%>">
        　</strong></td>
          </tr>
