...
function check(){
	...
	if (title.value==""){
		alert("タイトルは空にすることはできません!")
		title.focus()
		return false
	}
	if (rename.value==""){
		alert("名前は空にすることはできません!")
		rename.focus()
		return false
	}
	if (compname.value==""){
		alert("会社名は空にすることはできません!")
		compname.focus()
		return false
	}
	if (phone.value==""){
		alert("電話番号は空であってはなりません!")
		phone.focus()
		return false
	}
	if (z_body.value==""){
		alert("内容は空にすることはできません!")
		z_body.focus()
		return false
	}
	if (safecode.value==""){
		alert("検証コードは、空にすることはできません!")
		safecode.focus()
		return false
	}
}
...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="733" valign="top" bgcolor="#FFFFFF"><table width="733" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="38" class="zhans"><a href="feedback.asp">フィードバック</a></td>
      </tr>
    </table>
  ...
  <form name="form1" method="post" action="message_add.asp" onsubmit="return check()">
	...
	<tr>
	  ...
	  <td><input name="submit" type="submit" id="submit2" value=" 提出する " class="lyb_bor lyb_btn" />
		  　<input type="reset" name="Reset" value=" リセット " class="lyb_bor lyb_btn" /></td>
	</tr>
	</form>
</table>
           </Div>
