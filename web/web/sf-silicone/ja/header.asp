            ...
            <tr>
              <td><table width="159" border="0" cellspacing="0" cellpadding="0">
                  <tr><form id="form1" name="form1" method="post" action="product.asp">
                    ...
                    <input id="keyword" name="keyword" ></td>
                    <td width="23">
...
<%
	...
	sql="select id_lm,title_lm_en from pro_lm where fid=11 order by px desc,id_lm desc"
	rs.open sql,conn,1,1
	while not rs.eof
%>
            <li><a href="product.asp?dlm=11&zlm=<%=rs("id_lm")%>"><%=rs("title_lm_en")%></a></li>
<%	rs.movenext
	wend
	rs.close
	set rs=nothing
...
<%
	set rs=server.CreateObject("adodb.recordset")
	sql="select id_lm,title_lm_en from pro_lm where fid=22 order by px desc,id_lm desc"
	rs.open sql,conn,1,1
	while not rs.eof
%>
            <li><a href="product.asp?dlm=22&zlm=<%=rs("id_lm")%>"><%=rs("title_lm_en")%></a></li>
<%	rs.movenext
	wend
	rs.close
	set rs=nothing
...
<%
	set rs=server.CreateObject("adodb.recordset")
	sql="select id_lm,title_lm_en from pro_lm where fid=31 order by px desc,id_lm desc"
	rs.open sql,conn,1,1
	while not rs.eof
%>
            <li><a href="product.asp?dlm=31&zlm=<%=rs("id_lm")%>"><%=rs("title_lm_en")%></a></li>
<%	rs.movenext
	wend
	rs.close
	set rs=nothing
...
<%
	set rs=server.CreateObject("adodb.recordset")
	sql="select id_lm,title_lm_en from pro_lm where fid=37 order by px desc,id_lm desc"
	rs.open sql,conn,1,1
	while not rs.eof
%>
            <li><a href="product.asp?dlm=37&zlm=<%=rs("id_lm")%>"><%=rs("title_lm_en")%></a></li>
<%	rs.movenext
	wend
	rs.close
	set rs=nothing
...
<%
	set rs=server.CreateObject("adodb.recordset")
	sql="select id_lm,title_lm_en from pro_lm where fid=41 order by px desc,id_lm desc"
	rs.open sql,conn,1,1
	while not rs.eof
%>
            <li><a href="product.asp?dlm=41&zlm=<%=rs("id_lm")%>"><%=rs("title_lm_en")%></a></li>
<%	rs.movenext
	wend
	rs.close
	set rs=nothing
...
<%
	set rs=server.CreateObject("adodb.recordset")
	sql="select id_lm,title_lm_en from pro_lm where fid=44 order by px desc,id_lm desc"
	rs.open sql,conn,1,1
	while not rs.eof
%>
            <li><a href="product.asp?dlm=44&zlm=<%=rs("id_lm")%>"><%=rs("title_lm_en")%></a></li>
<%	rs.movenext
	wend
	rs.close
	set rs=nothing
...
<%
	set rs=server.CreateObject("adodb.recordset")
	sql="select id_lm,title_lm_en from pro_lm where fid=49 order by px desc,id_lm desc"
	rs.open sql,conn,1,1
	while not rs.eof
%>
            <li><a href="product.asp?dlm=49&zlm=<%=rs("id_lm")%>"><%=rs("title_lm_en")%></a></li>
<%	rs.movenext
	wend
	rs.close
	set rs=nothing
...
<%
	set rs=server.CreateObject("adodb.recordset")
	sql="select id_lm,title_lm_en from pro_lm where fid=54 order by px desc,id_lm desc"
	rs.open sql,conn,1,1
	while not rs.eof
%>
            <li><a href="product.asp?dlm=52&zlm=<%=rs("id_lm")%>"><%=rs("title_lm_en")%></a></li>
<%	rs.movenext
	wend
	rs.close
	set rs=nothing
