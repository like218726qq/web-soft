...
<%
	...
	sql="select title_lm_en from pro_lm where id_lm="&tlm&" "
...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
      ...
      <table width="733" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <div style=" line-height:180%;height:auto !important; height:610px;min-height:610px; ">
           <Div style=" line-height:180%; text-align:left; border-bottom:#CCCCCC  dotted 1px; padding-left:10px; font-weight:bold; font-size:14px">製品名：<span style="color:#666666"><%=title%></span></Div>
	       <%
    if img_sl<>"" then
    %>
    ...
    %>
    <Div style=" line-height:180%; text-align:left; border-bottom:#CCCCCC  dotted 1px; padding-left:10px; font-weight:bold; font-size:14px">製品の紹介</Div>
    <Div style=" line-height:180%; text-align:left; padding:10px; height:auto !important; height:210px; min-height:210px;">
	<%
	   if z_body="" then
	      response.Write("<span style='text-align:center; padding-top:20px;'>情報更新...</span>")
	   else
	   response.Write(z_body)
	   end if
	%></Div>
    <div class="back" style="text-align:right; height:30px; padding-top:10px"><a href="javascript:history.back();">[バック]</a></div>
</div>          </td>
        </tr>
        <tr>
