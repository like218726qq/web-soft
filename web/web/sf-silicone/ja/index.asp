      ...
      <tr>
        ...
        <ul id="limrq" style="overflow:hidden;height:20px;line-height:20px;">
           <%
			   ...
			   sql="select id,title,wtime from info_co where lm=15 and pass='yes' and tuijian='yes' order by px,id desc"
          ...
          <td background="images/bk_zhong.jpg" style="padding-left:19px; padding-top:4px;"><table width="955" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="290" valign="top"><table width="290" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="24" background="images/news.jpg" class="news_font1">新製品
                  <span style=" margin-top:3px; margin-right:5px; float:right">
                  <a href="product.asp"><img src="images/jiahao.jpg" title="続きを見る..."/></a></span></td>
                </tr>
                <tr>
                  <td valign="top" style="padding-top:20px;">
                   <%
					   set rs=server.CreateObject("adodb.recordset")
					   sql="select top 1 id,title_en,img_sl,z_body_en from pro_co where pass='yes' and tuijian='yes' and hot='yes' order by px,id desc"
					   rs.open sql,conn,1,1
					   if not rs.eof then
					   while not rs.eof
				   %>
                  ...
                  <a href="product_show.asp?id=<%=rs("id")%>">
                  <%=left(rehtml(rs("z_body_en")),560)&"..."%>
                  </a></span><span class="news_font1">&nbsp;&nbsp;<a href="product_show.asp?id=<%=rs("id")%>">もっと+</a></span>
                   <%
			   rs.movenext 
			   wend
			   end if
			...
			%>
              ...
              <td width="613" valign="top" style="padding-top:14px;"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                 <%	
					set rs=server.CreateObject("adodb.recordset")
					sql="select top 3 id,title_en,img_sl from pro_co where pass='yes' and tuijian='yes' order by px desc,id desc"
					rs.open sql,conn,1,1
					if not rs.eof then
					a=1
					while not rs.eof 
				%>
                  ...
                  <td <%if a mod 3<>0 then%>width="212"<%end if%>><table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <a href="product_show.asp?id=<%=rs("id")%>" title="<%=rs("title_en")%>">
        ...
        <td background="images/bk_zhong.jpg" style="padding-top:6px; padding-left:19px; padding-bottom:8px;"><table width="954" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="424" valign="top"><table width="424" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="24" background="images/about.jpg" class="news_font1">私達について
                 <span style=" margin-top:3px; margin-right:5px; float:right">
                  <a href="about.asp"><img src="images/jiahao.jpg" title="続きを見る..."/></a></span>                </td>
              </tr>
              <tr>
                <td valign="top" class="news_font" style="padding-top:24px;">
                  <%
				   set rs=server.CreateObject("adodb.recordset")
				   sql="select z_body,img_sl from tol_co where id=16" 
				   rs.open sql,conn,1,1
				   if not rs.eof then
				 %>
                <span class="news_font" style="padding-top:24px;">
                <img src="../<%=rs("img_sl")%>" width="215" height="112" class="ima1" /></span>
                 <%=left(rehtml(rs("z_body")),850)&"..."%>
                <span class="news_font1"><a href="about.asp">もっと+</a></span>
<%
				   end if
				   rs.close
				   set rs=nothing
            ...
            <td width="210" valign="top"><table width="210" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="24" background="images/product.jpg" class="news_font1">ケース
                 <span style=" margin-top:3px; margin-right:5px; float:right">
                  <a href="case.asp"><img src="images/jiahao.jpg" title="続きを見る..."/></a></span>
                </td>
              </tr>
              <tr>
                ...
                <%
				    set rs=server.CreateObject("adodb.recordset")
					sql="select top 1 img_sl from info_co where lm=16 and pass='yes' and tuijian='yes'"
					rs.open sql,conn,1,1
					if not rs.eof then
				%>
            ...
            <td width="232" valign="top"><table width="232" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="24" background="images/cantact.jpg" class="news_font1">お問い合わせ
                 <span style=" margin-top:3px; margin-right:5px; float:right">
                  <a href="contact.asp"><img src="images/jiahao.jpg" title="続きを見る..."/></a></span>
                </td>
              </tr>
              <tr>
                <td height="24">&nbsp;</td>
              ...
              <tr>
                <td>
                  ...
                  <%
				   set rs=server.CreateObject("adodb.recordset")
				   sql="select img_sl from tol_co where id=17" 
				   rs.open sql,conn,1,1
				   if not rs.eof then
				 %>
              ...
              <tr>
                <td class="news_font" style="padding-top:5px; padding-left:3px;">
                 <%
				   set rs=server.CreateObject("adodb.recordset")
				   sql="select z_body from tol_co where id=17" 
				   rs.open sql,conn,1,1
				   if not rs.eof then
