...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="733" valign="top" bgcolor="#FFFFFF"><table width="733" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="38" class="zhans"><a href="job.asp">仕事</a></td>
      </tr>
    </table>
	  ...
	  <TR>
		...
		<TD vAlign=top align=middle bgColor=#ffffff>
            <TABLE cellSpacing=1 cellPadding=3 width="100%" border=0 bgColor=#cccccc>
              <TR bgColor=#ffffff>
                <TD align=right width="16%" bgColor=#f3f3f3><strong><span id="result_box" lang="en" xml:lang="en">職名</span>：</strong></TD>
              ...
              <TR bgColor=#ffffff>
                <TD height="60" align=right vAlign=top bgColor=#f3f3f3><strong><span id="result_box2" lang="en" xml:lang="en">必要条件</span>：</strong></TD>
                <TD  colSpan=3 align="left" valign="top" style="line-height:20px; "><%=rs("z_body")%></TD>
              </TR>
              <TR bgColor=#ffffff>
                <TD align=right bgColor=#f3f3f3 height=18><strong><span id="result_box3" lang="en" xml:lang="en">人々の数</span>：</strong></TD>
                <TD width="37%" align="left"><%=rs("num")%></TD>
                <TD align=middle width="13%"  bgColor=#f3f3f3><strong><span id="result_box5" lang="en" xml:lang="en">職場</span>：</strong></TD>
                <TD width="34%" align="left"><%=rs("address")%></TD>
              </TR>
              <TR bgColor=#ffffff>
                <TD align=right bgColor=#f3f3f3 height=18><strong><span id="result_box4" lang="en" xml:lang="en">開始時刻</span>：</strong></TD>
                <TD width="37%" align="left"><%=rs("wtime")%></TD>
                <TD align=middle width="13%"  bgColor=#f3f3f3><strong>終了時間：</strong></TD>
