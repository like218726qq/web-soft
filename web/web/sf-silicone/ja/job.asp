...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <%
	...
	sql="select *  from job  where pass='yes' and lang='no' order by px desc,id desc"
	...
	<%
        ...
        wend
		  ...
		  response.Write("<div style='width:100%; text-align:center; margin-top:100px'>いいえジョブズません！</div>")
		end if 
        rs.close
        set rs=nothing
     %>
            ...
            <table width="690" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td align="center"><%if pagenum<>"" then call listpage(pra) end if%></td>
              </tr>
            </table>
            </td>
        </tr>
