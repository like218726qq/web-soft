...
<%
	...
	if id="" or not checknum(id) then
		call msg("error en el parámetro","")
	end if
	...
	sql="select title_lm_es from pro_lm where id_lm="&tlm&" "
...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="733" valign="top" bgcolor="#FFFFFF"><table width="733" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="38" class="zhans"><A href="product.asp"><span id="result_box" lang="es" xml:lang="es">producto</span></A></td>
      </tr>
    </table>
      ...
      <table width="733" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <div style=" line-height:180%;height:auto !important; height:610px;min-height:610px; ">
           <Div style=" line-height:180%; text-align:left; border-bottom:#CCCCCC  dotted 1px; padding-left:10px; font-weight:bold; font-size:14px">Nombre del producto：<span style="color:#666666"><%=title%></span></Div>
	       <%
    if img_sl<>"" then
    %>
    ...
    %>
    <Div style=" line-height:180%; text-align:left; border-bottom:#CCCCCC  dotted 1px; padding-left:10px; font-weight:bold; font-size:14px">Introducción de producto</Div>
    <Div style=" line-height:180%; text-align:left; padding:10px; height:auto !important; height:210px; min-height:210px;">
	<%
	   if z_body="" then
	      response.Write("<span style='text-align:center; padding-top:20px;'>Información de actualización...</span>")
	   else
	   response.Write(z_body)
	   end if
	%></Div>
    <div class="back" style="text-align:right; height:30px; padding-top:10px"><a href="javascript:history.back();">[espalda]</a></div>
</div>          </td>
        </tr>
        <tr>
