...
<%
	...
	sql="select * from tol_co where id=23"
  ...
  <tr>
    ...
    <td width="733" valign="top" bgcolor="#FFFFFF"><table width="733" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="733" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td background="images/product1_zhong.jpg" style="padding:20px 20px 10px 20px; height:615px; line-height:180%; text-align:justify" valign="top">
          <%=z_body%>
          </td>
        </tr>
        <tr>
