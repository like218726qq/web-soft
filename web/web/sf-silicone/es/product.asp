...
<%
	...
	if keyword<>"" then
	    if keyword="Please enter a keyword..." then
...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="733" valign="top" bgcolor="#FFFFFF"><table width="733" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="38" class="zhans"><A href="product.asp">producto</A></td>
      </tr>
    </table>
      ...
      <table width="733" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <table border="0" cellspacing="0" cellpadding="0">
            ...
            <%	
	set rs=server.CreateObject("adodb.recordset")
	sql="select id,title_es,img_sl,pro_guige from pro_co where pass='yes' "&sq&" order by px desc,id desc"
	rs.open sql,conn,1,1
	if not rs.eof then
		pagenum=9
		rs.pagesize=pagenum
...
%>
              ...
              <td <%if a mod 3<>0 then%>width="236"<%end if%>><table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <a href="product_show.asp?id=<%=rs("id")%>"><%=rs("title_es")%></a>
                  </td>
                </tr>
              </table></td>
              <%if a mod 3=0 then
              ...
              <%
				    ...
				    response.Write("<div style='width:600px; margin-top:60px; text-align:center'>Información de actualización</div>")
				end if	
				rs.close
				set rs=nothing
			%>
