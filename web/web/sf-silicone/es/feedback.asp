...
function check(){
	...
	if (compname.value==""){
		alert("Nombre de la empresa no puede estar vacío!")
		compname.focus()
		return false
	}
	if (phone.value==""){
		alert("Tel no puede estar vacío!")
		phone.focus()
		return false
	}
	if (z_body.value==""){
...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="733" valign="top" bgcolor="#FFFFFF"><table width="733" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="38" class="zhans"><a href="feedback.asp">realimentación</a></td>
      </tr>
    </table>
  ...
  <form name="form1" method="post" action="message_add.asp" onsubmit="return check()">
    <tr>
	  <td width="29%" height="32" align="right">título： </td>
	...
	<tr>
	  <td height="32" align="right">Nombre de la compañía：</td>
	  <td height="32">
	...
	<tr>
	  <td height="32" align="right">dirección：</td>
	...
	<tr>
	 ...
	 <tr>
	  <td height="30" align="right">del código de verificación：</td>
	...
	<tr>
	  ...
	  <td><input name="submit" type="submit" id="submit2" value=" Presentar " class="lyb_bor lyb_btn" />
		  　<input type="reset" name="Reset" value=" Reajustar " class="lyb_bor lyb_btn" /></td>
	</tr>
	</form>
</table>
           </Div>
