...
<table border="0" cellpadding="0" cellspacing="0" width="1005px" height="225" align="center" style="background-image:url(images/wg_03.jpg)">
	<tr>
        ...
        <%
			...
			do while not rs.eof 
		%>
        	<td align="center" valign="bottom" width="300px"><a href="<%=rs("link_url")%>"><img src="<%=rs("img_sl")%>" style="margin:30px 40px" onmousemove="test(this)" onmouseout="testOut(this)" /></a></td>
        <%
			rs.movenext
			loop
			rs.close
