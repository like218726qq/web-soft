...
<div style=" margin-bottom:20px; line-height:25px">
	<table border="0" cellpadding="0" cellspacing="0" width="1000px" align="center">
    	<tr>
        	<td height="40px" style="line-height:40px">Current Location：<a href="index.asp">Home</a> > <a href="product.asp">Product</a> <%=dao%></td>
        </tr>
    	<tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="1000px" align="center" style="margin-top:10px">
        <tr>
              ...
              <tr>
                        ...
                        <td width="83%" style="background-image:url(images/down_05.jpg); color:#FFFFFF" align="center"; id="td1">Product Features</td>
                        <td width="7%"><img src="images/down_07.jpg" id="img21" /></td>
                  </tr>
                </table>
       	  </td>
            <td width="100px">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style=" cursor:pointer" onclick="show('2')">
                    <tr>
                      ...
                      <td width="84%" style="background-image:url(images/down_11.jpg); color:#FFFFFF" align="center"; id="td2">Specifications</td>
            ...
            <td width="100px">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style=" cursor:pointer" onclick="show('3')">
                    <tr>
                      ...
                      <td width="84%" style="background-image:url(images/down_11.jpg); color:#FFFFFF" align="center"; id="td3">Details Photos</td>
            ...
            <td width="100px">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style=" cursor:pointer" onclick="show('4')">
                    <tr>
                      ...
                      <td width="84%" style="background-image:url(images/down_11.jpg); color:#FFFFFF" align="center"; id="td4">Buy Now</td>
...
<!-- Baidu Button END --></td>
        ...
        <tr>
        	<td>
				...
				<%=z_body_en%></div>
                <div id="div2" style="margin:10px; display:none"><%=z_body_1_en%></div>
                <div id="div3" style="margin:10px; display:none"><%=z_body_2_en%></div>
                <div id="div4" style="margin:10px; display:none"><%=z_body_3_en%></div>
            </td>
        </tr>
    </table>
</div>
