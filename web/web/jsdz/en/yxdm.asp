...
<%
	sql="select top 1 * from info_co where lm=34 order by px desc, id desc"
...
<I id=prev class=prev title=Previous></I>
...
<%
	...
	rs.close
%>
</DIV><I id=next class=next title=Next></I></DIV></DIV></DIV>
    	...
    	<td valign="top" style="background:url(images/news_06.jpg) bottom repeat-x;border:1px solid #CCCCCC; border-top:none">
        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
  				<tr style="background-image:url(images/ind_42.jpg)">
                    ...
                    <td width="95%">
               	  <b style="font-size:14px; color:#FFFFFF">Online shopping center</b></td>
                </tr>
   	  ...
   	  <td width="20px"></td>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:0px">
                <tr>
                  <td height="30px" style="background-image:url(images/news1_03.jpg)">Current Location：<a href="index.asp">Home</a> > Online shopping > <%=title%></td>
                </tr>
          </table>
