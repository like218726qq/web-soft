...
<%
	...
	if id<>"" and checknum(id) then
		...
		sql="select top 1 * from tol_co where lm=9 order by px desc,id asc"
	end if
...
var swf_config = "|2|||0xFFFFFF|0x930000||5|2|1|_blank"
    	...
    	<td valign="top" style="background:url(images/news_06.jpg) bottom repeat-x;border:1px solid #CCCCCC; border-top:none">
        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
  				<tr style="background-image:url(images/ind_42.jpg)">
                    ...
                    <td width="95%">
               	  <b style="font-size:14px; color:#FFFFFF">Yagala Brand</b></td>
                </tr>
   	  ...
   	  <td width="20px"></td>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:0px">
                <tr>
                  <td height="30px" style="background-image:url(images/news1_03.jpg)">Current Location：<a href="index.asp">Home</a> > <a href="about.asp">Yagala Brand</a> > <%=title%></td>
                </tr>
          </table>
