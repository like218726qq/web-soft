...
<tr>
    	<td valign="top" style="background:url(images/news_06.jpg) bottom repeat-x;border:1px solid #CCCCCC; border-top:none">
   	  ...
   	  <td width="20px"></td>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:0px">
                <tr>
                  <td height="30px" style="background-image:url(images/news1_03.jpg)">Current Location：<a href="index.asp">Home</a> > <a href="job.asp">Recruitment</a> <%=dao%></td>
                </tr>
          </table>
          <br />
          <%
	Set rs= Server.CreateObject("ADODB.Recordset")
	sql="select *  from job  where pass='yes' and lang='en' and lm='"&id&"' order by px desc,id desc"
	...
	<TABLE width="100%" border=0 align="center" cellPadding=1 cellSpacing=1 bgColor=#CCCCCC style="margin-bottom:10px">
	  <TR>
		<TD align=middle bgColor="#f4f4f4"><%call listpageen(key) %></TD>
	  </TR>
</TABLE>
	<%
	end if
