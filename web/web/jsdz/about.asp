...
<%
	...
	if id<>"" and checknum(id) then
		...
		sql="select top 1 * from tol_co where lm=1 order by px desc,id asc"
	end if
    	...
    	<td valign="top" style="background:url(images/news_06.jpg) bottom repeat-x;border:1px solid #CCCCCC; border-top:none">
   	  ...
   	  <td width="20px"></td>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:0px">
                <tr>
                  <td height="30px" style="background-image:url(images/news1_03.jpg)">当前位置：<a href="index.asp">首页</a> > <a href="about.asp">雅镭品牌</a> > <%=title%></td>
                </tr>
          </table>
