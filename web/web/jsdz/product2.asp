...
<%
	...
	if keyword<>"" then
		dao=" &gt; 搜索结果"
		sq=sq&" and title like'%"&keyword&"%' or f_body  like'%"&keyword&"%' or z_body like '%"&keyword&"%' or  z_body_1 like '%"&keyword&"%' or z_body_2 like '%"&keyword&"%' or"
               	...
               	<td width="80px">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style=" cursor:pointer" onclick="show('<%=i%>')">
                        <tr style="background-image:url(<%if lm=rs("id_lm") then%>images/down_05.jpg<%else%>images/down_11.jpg<%end if%>);">
                            ...
                            <td width="80%" style=" color:#FFFFFF" align="center";><a href="product2.asp?lm=<%=rs("id_lm")%>" class="a1"><font style=" font-size:12px;<%if lm=rs("id_lm") then%>color:#fff<%end if%>"><%=rs("title_lm")%></font></a></td>
            ...
            <td width="789" valign="top">
  				<table border="0" cellpadding="0" cellspacing="0" width="100%">
                	<tr style="background-color:#FFFFFF">
                    	<td width="86%" align="right" style="color:#666666"><strong>选择检视：</strong></td>
                    	<td width="14%" align="right" style="color:#666666">
                        <img src="images/21.jpg" border="0" usemap="#Map" />
                        <map name="Map" id="Map">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <%	
                    ...
                    <tr>
						<td style=" border-bottom:1px dashed #000000">
                        	<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:5px auto">
                            	<tr>
                               	  <td align="center" rowspan="4" width="220px"><a href="product_show.asp?id=<%=rs("id")%>"><img src="<%=rs("img_sl")%>" /></a></td>
                                    <td align="left" style="font-size:18px; font-family:'微软雅黑'; font-weight:bold">
                                    <a href="product_show.asp?id=<%=rs("id")%>"><%=rs("title")%></a></td>
                                </tr>
                                <tr>
                                	<td align="left"><b style="font-size:14px"><a href="product_show.asp?id=<%=rs("id")%>"><%=rs("pro_danwei")%></a></b></td>
                                </tr>
                                <tr>
                                	<td align="left"><%=rs("f_body")%></td>
                                </tr>
                                 <tr>
                                	<td align="left"><b><a href="product_show.asp?id=<%=rs("id")%>"><img src="images/pro2.jpg" /></a></b></td>
                                </tr>
                            </table>
                        </td>	
                    </tr>			
                    ...
                    <tr>
						<td style=" border-bottom:1px dashed #000000">
                       	  <table border="0" cellpadding="0" cellspacing="0" width="95%" style="margin:15px auto" align="center">
                            	<tr>
                                    <td align="left" style="font-size:20px; font-family:'微软雅黑'; font-weight:bold">
                                    <a href="product_show.asp?id=<%=rs("id")%>"><%=rs("title")%></a></td>
                                    <td align="center" rowspan="4" width="220px"><a href="product_show.asp?id=<%=rs("id")%>"><img src="<%=rs("img_sl")%>" /></a></td>
                                </tr>
                                <tr>
