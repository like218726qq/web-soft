	...
	<tr>
    	<td width="337" valign="top">
        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr style=" background-image:url(images/ind_42.jpg)">
                    ...
                    <td width="78%" style="color:#FFFFFF; font-size:14px"><b>新闻中心</b></td>
                    <td width="16%"><a href="news.asp?lm=3" class="a1">More >></a></td>
                </tr>
                <tr>
                	<td colspan="3" style=" line-height:25px;border:1px solid #CCCCCC" height="170px">
						<%
                            sql="select top 1 * from info_co where lm=3 or lm=4 or lm=5 or lm=23 and pass='yes' and hot='yes' order by px desc,id desc"
                            set rs=conn.execute(sql)
                            if not rs.eof then
                        %>
                        ...
                        %>
                        <%
							sql="select top 6 * from info_co where lm=3 or lm=4 or lm=5 or lm=23 and pass='yes' and tuijian='yes' order by px desc,id desc"
							set rs=conn.execute(sql)
							do while not rs.eof
						%>
        ...
        <td width="340" valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr style=" background-image:url(images/ind_42.jpg)">
                    ...
                    <td width="74%" style="color:#FFFFFF; font-size:14px"><b>产品中心</b></td>
        ...
        <td width="340" valign="top">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr style=" background-image:url(images/ind_42.jpg)">
                	<td width="8%"><img src="images/ind_39.jpg" /></td>
                    <td width="76%" style="color:#FFFFFF; font-size:14px"><b>行业资讯</b></td>
                    <td width="16%"><a href="news.asp?lm=12" class="a1">More >></a></td>
                </tr>
                <tr>
                	<td colspan="3" style=" line-height:25px;border:1px solid #CCCCCC" height="170px" valign="top">
                    	<table border="0" cellpadding="0" cellspacing="0" width="100%" >
                        <%
							sql="select top 6 * from info_co where lm=12 and pass='yes' and tuijian='yes' order by px desc,id desc"
							set rs=conn.execute(sql)
							do while not rs.eof
						%>
           	  			  	<tr>
