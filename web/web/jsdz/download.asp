    	...
    	<td valign="top" style="background:url(images/news_06.jpg) bottom repeat-x;border:1px solid #CCCCCC; border-top:none">
        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
  				<tr style="background-image:url(images/ind_42.jpg)">
                    ...
                    <td width="95%">
               	  <b style="font-size:14px; color:#FFFFFF">服务支持</b></td>
                </tr>
                ...
                <tr>
                	<td style="border-bottom:1px dashed #CCCCCC" height="30px">&nbsp;</td>
                   <td align="left" style="border-bottom:1px dashed #CCCCCC; padding-left:20px"><img src="images/ind_47.jpg" />&nbsp;<a href="download.asp">在线下载</a></td>
              	</tr>
                <tr>
                	<td height="142px"></td>
                    <td height="142px"></td>
   	  ...
   	  <td width="20px"></td>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:0px">
                <tr>
                  <td height="30px" style="background-image:url(images/news1_03.jpg)">当前位置：<a href="index.asp">首页</a> > <a href="service.asp">服务支持</a> > 在线下载</td>
                </tr>
          </table>
          <div style="margin-top:20px; margin-bottom:20px; line-height:25px">
          	<table border="0" cellpadding="0" cellspacing="0" width="90%">
          		<tr>
            		<%
						sql="select * from info_lm where fid=7"
						set rs=conn.execute(sql)
						i=1
						do while not rs.eof
					%>
  ...
  <tr>
					...
					%>
                    	<table border="0" cellpadding="0" cellspacing="1" width="95%" style="margin:20px; <%if i<>1 then%>display:none<%end if%>" bgcolor="#CCCCCC" id="table<%=i%>">
                            	...
                            	<td width="10%" height="30px" align="center">序号</td>
                       			<td width="20%" align="center">产品名称</td>
                          		<td width="13%" align="center">产品型号</td>
                          		<td width="13%" align="center">文件类型</td>
                       			<td width="31%" align="center">备注</td>
                          		<td width="13%" align="center">立即下载</td>
                          	</tr>
                            <%
                            ...
                            <tr style="background-color:#FFFFFF">
                            	<td width="10%" height="30px" align="center"><%=rs1("id")%></td>
                          		...
                          		<td width="13%" align="center"><a href="down.asp?filename=<%=rs1("dow_sl")%>">点击下载</a></td>
                          	</tr>
                            <%
								rs1.movenext
								loop
