...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg" id="dis_dow_pro" <%if dis_dow_sl="no" then response.write"style='display:none;'" end if%>>          
        <td width="120" align="right"><strong>产品名称：</strong></td>          
        <td ><input type="test" name="dow_pro" id="dow_pro" value="<%=dow_pro%>"></td>
    </tr>
    <tr class="tdbg" id="dis_dow_xh" <%if dis_dow_sl="no" then response.write"style='display:none;'" end if%>>          
        <td width="120" align="right"><strong>产品型号：</strong></td>          
        <td ><input type="test" name="dow_xh" id="dow_xh" value="<%=dow_xh%>"></td>
    </tr>
    ...
    <tr class="tdbg" id="dis_dow_name" <%if dis_dow_sl="no" then response.write"style='display:none;'" end if%>>          
        <td width="120" align="right"><strong>文件类型：</strong></td>          
        <td ><input type="test" name="dow_name" id="dow_name" value="<%=dow_name%>"></td>
    </tr>
    <tr class="tdbg" id="dis_dow_bz"  <%if dis_dow_sl="no" then response.write"style='display:none;'" end if%>>          
        <td width="120" align="right"><strong>备注：</strong></td>          
        <td ><textarea name="dow_bz" id="dow_bz" cols="72" rows="4"><%=dow_bz%></textarea></td>
    </tr>
