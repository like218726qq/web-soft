...
function check_display(){
	...
	var dis_dow_name=document.getElementById("dis_dow_name");
	var dis_dow_xh=document.getElementById("dis_dow_xh");
	var dis_dow_pro=document.getElementById("dis_dow_pro");
	var dis_dow_bz=document.getElementById("dis_dow_bz");
	...
	for (i=0;i<=counter;i++){
		if (lm==shu_lm[i][0]){
			...
			(shu_lm[i][11]=="yes")?dis_dow_name.style.display="":dis_dow_name.style.display="none";
			(shu_lm[i][11]=="yes")?dis_dow_pro.style.display="":dis_dow_pro.style.display="none";
			(shu_lm[i][11]=="yes")?dis_dow_xh.style.display="":dis_dow_xh.style.display="none";
			(shu_lm[i][11]=="yes")?dis_dow_bz.style.display="":dis_dow_bz.style.display="none";
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg" id="dis_dow_pro" style="display:none;">          
        <td width="120" align="right"><strong>产品名称：</strong></td>          
        <td ><input type="test" name="dow_pro" id="dow_pro"></td>
    </tr>
    <tr class="tdbg" id="dis_dow_xh" style="display:none;">          
        <td width="120" align="right"><strong>产品型号：</strong></td>          
        <td ><input type="test" name="dow_xh" id="dow_xh"></td>
    </tr>
    ...
    <tr class="tdbg" id="dis_dow_name" style="display:none;">          
        <td width="120" align="right"><strong>文件类型：</strong></td>          
        <td ><input type="test" name="dow_name" id="dow_name"></td>
    </tr>
    <tr class="tdbg" id="dis_dow_bz" style="display:none;">          
        <td width="120" align="right"><strong>备注：</strong></td>          
        <td ><textarea name="dow_bz" id="dow_bz" cols="72" rows="4"></textarea></td>
    </tr>
