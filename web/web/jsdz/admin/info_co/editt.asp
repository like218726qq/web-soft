...
dow_name=html(request.Form("dow_name"))
dow_pro=html(request.Form("dow_pro"))
dow_xh=html(request.Form("dow_xh"))
dow_bz=html(request.Form("dow_bz"))
