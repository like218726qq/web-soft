...
<%  Session.CodePage=65001
	...
	sub listpageEn(key)
		listp=listp&"<TABLE cellSpacing=0 cellPadding=0  align=center border=0 style='color:#666666' ><TR>"&chr(10)
		listp=listp&"<TR>"&chr(10)
		listp=listp&"<TD ><font color='#ff0000'>"&pageno&"</font> Page | Total Of <font color='#ff0000'>"&pagezong&"</font> Pages | <font color='#ff0000'>"&pagenum&"</font> / Page | Total <font color='#ff0000'>"&counter&"</font></td>"&chr(10)
		listp=listp&"<td width='100'>&nbsp;</td>"&chr(10)
		listp=listp&"<td>"
		if pageno=1 then
		...
		listp=listp&"<td width='10'></td>"&chr(10)
		listp=listp&"<td><input type='text' name='pagee' id='pagee' maxlength='6' style='width:35px;BORDER: #aacbe1 1px solid; font-size:12px;' value='"&pageno&"'></td><td width='5'></td>"&chr(10)
		listp=listp&"<td ><input type='button' name='buttonn' value='Go' onclick=""location='?page='+document.getElementById('pagee').value+'"&key&"'"" style='BORDER: #aacbe1 1px solid; font-size:12px;'></td>"&chr(10)
		listp=listp&"</tr>"&chr(10)
		listp=listp&"</table>"&chr(10)
		response.write listp
	end sub
