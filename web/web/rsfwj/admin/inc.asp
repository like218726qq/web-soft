...
<%  Session.CodePage=65001
	...
	'普通分页
	sub listpage(key)
		listp=listp&"<TABLE cellSpacing=0 cellPadding=0  align=right border=0 style='color:#666666' ><TR>"&chr(10)
		...
		listp=listp&"<TD >&nbsp;&nbsp;页次:"&pageno&"/<font color='#666666'>"&pagezong&"</font>&nbsp;共<font color='#666666'>"&counter&"</font>条记录</td>"&chr(10)
		listp=listp&"</tr>"&chr(10)
	...
	sub listpage_num(pra)
		htm = "<div class=""pages"" align=center><ul>"
		if pageno>1 then
