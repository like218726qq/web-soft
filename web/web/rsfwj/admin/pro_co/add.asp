...
<td class="tdbg" ><strong>
        ...
        <input name="pro_money" type="text" id="pro_money2" maxlength="50">
              ...
              <tr class="tdbg">
                <td width="120" align="right"><strong >详细信息：</strong></td>
                <td>
    ...
    %>	                </td>          
           ...
           <tr class="tdbg" style="display:none;">
                <td width="120" align="right"><strong >右侧参数：</strong></td>
                <td>
  
     <%
    oFCKeditor.Value = ""
    oFCKeditor.Create "z_body_cs"
    %>	  	                </td>          
          </tr>
             <tr class="tdbg" style="display:none;" >
                <td width="120" align="right"><strong >产品特点：</strong></td>
                <td>
   
     <%
    oFCKeditor.Value = ""
    oFCKeditor.Create "z_body_pj"
    %>	            </td>          
          </tr>
        <tr class="tdbg" >          
...
<!--在此处可加多图上传-->
 <tr class="tdbg" style="display:none;">          
            <td width="120" align="right"><strong>资料上传：</strong></td>          
            <td ><IFRAME id="frame1" name="frame1" style="margin-top:2px;"height=22 src="upd.asp?frameid=frame3&kuang=dowl_sl" width="280" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="dowl_sl" id="dowl_sl"></td>
        </tr>
