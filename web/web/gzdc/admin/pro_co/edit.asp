...
<input  type="hidden" name="w_url" value="<%=w_url%>">
      <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
		...
		<tr class="tdbg">
		  ...
		  <tr class="tdbg2">
                <td width="120" align="right" class="tdbg"><strong>门牌号：</strong></td>
        <td class="tdbg">               
    <input name="pro_danwei" type="text" id="pro_danwei" maxlength="50" value="<%=pro_danwei%>">
    <strong>房厅式：
    <input name="pro_guige" type="text" id="pro_guige" maxlength="50" value="<%=pro_guige%>" />
    </strong></td>
	    </tr>
<tr class="tdbg2">
<td width="120" align="right" class="tdbg"><strong>售价：</strong> </td>
      <td class="tdbg" ><input name="pro_money" type="text" id="pro_money" maxlength="50" value="<%=pro_money%>">              </td>
        </tr>
