...
<table width="100%"  border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr class="tdbg">
    ...
    <td ><a href="default.asp">资料管理首页</a></td>
  </tr>
</table>
<br />
...
<table width="100%"  border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr>
	...
	<script>
        ...
        document.form1.lm.disabled='disabled';
    </script>
    ...
    <td class="tdbg"><input  name="ti" type="text" disabled="disabled" id="ti" size="30" maxlength="50" value="<%=title%>"><input  name="title" type="hidden" id="title" size="30" maxlength="50" value="<%=title%>"></td>
  </tr>
   <tr>
