...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">  
    ...
    <tr class="tdbg">    
        ...
        <td ><a href="default.asp">管理首页</a>&nbsp;|&nbsp;<a href="add.asp">添加</a></td>
  </tr>
</table>
<br />
...
<td class="tdbg" ><strong>
        <input name="pro_guige" type="text" id="pro_guige" maxlength="50">　</strong></td>
          </tr>
    ...
    %>	                </td>          
        ...
        <tr class="tdbg" >          
            ...
            <td ><IFRAME id="frame1" name="frame1" style="margin-top:2px;"height=22 src="up.asp?frameid=frame1&kuang=img_sl" width="400" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="img_sl" id="img_sl"></td>
        </tr>
