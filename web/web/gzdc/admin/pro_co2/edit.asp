...
sql="select * from pro_co2 where id="&id
...
'获取该信息所在分类是否可添加信息
set rs=server.CreateObject("adodb.recordset")
sql="select add_xx from pro_lm2 where id_lm="&lm&""
rs.open sql,conn,1,1
if rs.eof then
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">  
    ...
    <tr class="tdbg">    
        ...
        <td ><a href="default.asp">管理首页</a>&nbsp;|&nbsp;<a href="add.asp">添加产品</a></td>
  </tr>
</table>
<br />
		...
		<tr class="tdbg">
          ...
          <td>				  
            <select name="lm">
                ...
                sql="select * from pro_lm2 where fid=0 order by px desc,id_lm desc"
                ...
                sub addinfo(fid,i)
                i=i&"&nbsp;"
                sql="select * from pro_lm2 where fid="&fid&" order by px desc,id_lm desc"
          ...
          <tr class="tdbg">
            <td width="120" align="right"><strong>名称：</strong></td>
            <td ><input name="title" type="text" id="title" value="<%=title%>" size="30" maxlength="150"></td>
          </tr>
     
		  <tr class="tdbg2">
                <td width="120" align="right" class="tdbg"><strong>职位：</strong></td>
        <td class="tdbg">               
...
<tr class="tdbg2">
<td width="120" align="right" class="tdbg"><strong>电话：</strong></td>
      <td class="tdbg" ><input name="pro_guige" type="text" id="pro_guige" maxlength="50" value="<%=pro_guige%>">        　              </td>
        </tr>

		      <tr class="tdbg"  style="display:none;">
                <td width="120" align="right"><strong>特长：</strong></td>
                <td>
    ...
    %>		  		</td>
              ...
              <tr class="tdbg">
                ...
                <td>
               <IFRAME id="frame1" name="frame1" style="margin-top:2px;"height=22 src="uploadd.asp?frameid=frame1&kuang=img_sl&img_sl=<%=img_sl%>" width="400" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="img_sl" id="img_sl" value="<%=img_sl%>"></td>
          </tr>
