...
'获取该信息所在分类是否可添加信息
set rs=server.CreateObject("adodb.recordset")
sql="select add_xx from pro_lm1 where id_lm="&lm&""
rs.open sql,conn,1,1
if rs.eof then
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">  
    ...
    <tr class="tdbg">    
        ...
        <td ><a href="default.asp">出售管理首页</a>&nbsp;|&nbsp;<a href="add.asp">添加信息</a></td>
  </tr>
</table>
<br />
		...
		<tr class="tdbg">
          ...
          <td>				  
            <select name="lm">
                ...
                sql="select * from pro_lm1 where fid=0 order by px desc,id_lm desc"
                ...
                sub addinfo(fid,i)
                i=i&"&nbsp;"
                sql="select * from pro_lm1 where fid="&fid&" order by px desc,id_lm desc"
		  ...
		  <tr class="tdbg2">
                <td width="120" align="right" class="tdbg"><strong>面积：</strong></td>
        <td class="tdbg">               
