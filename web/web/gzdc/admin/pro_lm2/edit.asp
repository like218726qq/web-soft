...
<INPUT name="id" type="hidden" value="<%=id%>">
  ...
  <TD>
			...
			<SELECT name="fid">
				...
				sql="select * from pro_lm2 where fid=0 and xia='yes' order by px desc,id_lm desc"
				...
				sql="select * from pro_lm2 where fid="&fid&" and xia='yes' order by px desc,id_lm desc"
