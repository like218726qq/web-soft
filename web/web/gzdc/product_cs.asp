...
<table width="1002" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#fffefa">
  <tr>
    ...
    <td width="737" valign="top"><table width="737" border="0" cellspacing="0" cellpadding="0" style="border-bottom:2px solid #e7e8e7; margin-bottom:28px;">
      <tr>
         <td style="background:url(images/pro_06.jpg); width:715px; height:23px; color:#a18307; font-size:14px; font-weight:bold; padding:6px 0 0 22px;" valign="middle"> 出租房源</td>
      </tr>
      <tr>
        <td>
        ...
        <%
					...
					sql="select * from pro_co1 where pass='yes'  order by px desc,id desc"
        	...
        	<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">	
               <tr>				
                  ...
                  <td width="605" align="left" valign="middle" style="border-bottom:dotted 1px #ccc; padding-left:5px;">
                    <a href="product_cs_show.asp?id=<%=rs("id")%>"><%=rs("title")%></a>									   </td>
