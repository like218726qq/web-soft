  ...
  <tr>
	...
	<table width="966" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="473" background="images/products_12.jpg" style="font-family:'微软雅黑'; font-size:14px; color:#FF0000">资质认证</td>
        <td width="473" align="right" background="images/products_12.jpg">您现在所在的位置：<a href="index.asp">首页</a> &gt; <a href="honor.asp">资质认证</a> &gt; <%=pro_lm_title(request.QueryString("fid"))%></td>
