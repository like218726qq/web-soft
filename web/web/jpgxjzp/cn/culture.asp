...
<div class="contleft">
    ...
    <div class="title">
    	<span class="hongtit"><a href="video.asp"><b>品酒文化<br /></b><strong>Wind Culture</strong></a></span>
...
'		  set rs=nothing
        ...
        <ul class="video clear">
            ...
            <li><a href="Video.asp"><b>视频欣赏<br />
        	</b><strong>Wine Culture</strong></a></li>
        </ul>
    </div>
</div>
<div class="contright">
	<h4 class="contrtit"><b>品酒文化<br /></b> <span>Wind Culture</span></h4>
    <ul class="pic">
    	<!--#include file="../html.culture.asp"-->
    </ul>
