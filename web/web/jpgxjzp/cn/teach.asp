  ...
  <tr>
	...
	<table width="966" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="473" background="images/products_12.jpg" style="font-family:'微软雅黑'; font-size:14px; color:#FF0000"><%=title%></td>
        <td width="473" align="right" background="images/products_12.jpg">您现在所在的位置：<a href="index.asp">首页</a> &gt; <a href="teach.asp">润彩风采</a> &gt; <%=title%></td>
      ...
      <table width="966" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style=" overflow:hidden; padding:20px; font-size:13px; line-height:180%;">
                    <%=z_body%>
			</td>
        </tr>
      </table>
