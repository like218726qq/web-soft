...
<table width=99% ><tr>			
 <%
	...
	%>
     	<td>
        <table width="300" cellpadding="0" cellspacing="0" class="table0">
              <tr>
                ...
                <td>
				<table>
                <tr><td>品名：<%=rs("pro_can1")%></td></tr>
                <tr><td>酒庄等级：<%=rs("pro_can2")%></td></tr>
                <tr><td>产区：<%=rs("pro_can3")%></td></tr>
                <tr><td>年份：<%=rs("pro_can4")%></td></tr>
                <tr><td>BR评分：<%=rs("pro_can5")%></td></tr>
                <tr><td>华洪评级：<%=rs("pro_can6")%></td></tr>
                <tr><td>酒行零售价：<span style="color:red; font-weight:bold; font-size:13px;">￥<%=rs("pro_can7")%></span></td></tr>
                </table>
              </tr>
         </table>
         </td>    
