...
.title2{ font-size:15px; height:32px; line-height:32px; font-weight:bold;}
/* 最小寬度 */
...
<table class="table">
	...
	<tr><td align="center"><div style="display:none;">
				...
				rel="zoom-width: 300px; zoom-height: 250px; zoom-position: right;">          
				 <img src="<%=img_sl%>" 1onerror="img_error(this,'images/2009072917363773499.jpg')"/>
				</a>
				<img src="<%=img_sl%>" 1onerror="img_error(this,'images/2009072917363773499.jpg')"   class="MagicZoomLoading max_width" alt="Loading Zoom, please wait"/>
	</div></td></tr>
    <tr>
            <td align="center">
...
'response.Write vid_sl
%>
<SCRIPT type=text/javascript>
var url=(""+window.location).substr(0,(""+window.location).lastIndexOf('/'));
var url=url.substr(0,url.lastIndexOf('/')+1);
//alert(url);
