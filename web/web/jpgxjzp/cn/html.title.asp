...
<meta name="describe" content="<%=site_des%>" />
...
function change_keys()
	if temp_titles<>"" then site_title=temp_titles end if
	if temp_keys<>"" then site_keys=temp_keys end if
	if temp_des<>"" then site_des=temp_des end if
end function
%>
