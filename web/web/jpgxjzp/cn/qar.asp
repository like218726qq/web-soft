...
<div class="mainBg">
    ...
    <div style="height:30px; line-height:30px; border-bottom:1px solid #dcdcdc;">&nbsp;&nbsp;当前位置：<a href="index.asp">首页</a> >> <a href="qar.asp">有问有答</a> >> <%=title%></div>
    <table style="width:90%; margin:0 auto;">
    <tr>
    <td style="line-height:32px; font-size:15px; font-weight:bold; color:#5A8C13; vertical-align:top; width:150px;">
     <div>有问有答</div>
     <i><%call tol_co_nav(10,"qar.asp")%></i>
    </td>
    <td>
