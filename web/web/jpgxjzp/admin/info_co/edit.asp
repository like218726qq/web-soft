...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">  
		...
		<tr class="tdbg">   
			...
			<td><a href="default.asp<%=url_attr%>">信息管理首页</a>&nbsp;|&nbsp;<a href="add.asp<%=url_attr%>">添加信息</a></td>
		</tr>
	</table>
<br />
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg" id="dis_info_from" <%if dis_info_from="no"  then response.write"style='display:none;'" end if%>>           
         ...
         <td ><input name="info_from" type="text" id="info_from"   maxlength="50"  value="<%=info_from%>">
          &nbsp; 信息作者：<input name="info_author" type="text" id="info_author"   maxlength="50" value="<%=info_author%>"/></td >
    </tr>
    ...
    <textarea name="f_body" style="width:500px;height:200px;visibility:hidden;" class="kindeditor4"><%=tohtml(f_body)%></textarea>   
        </td>
    </tr>
    ...
    <tr class="tdbg" id="dis_img_sl"  <%if dis_img_sl="no" then response.write"style='display:none;'" end if%>>          
        ...
        <td ><IFRAME id="frame1" name="frame1" style="margin-top:2px;"height=22 src="uploadd.asp?frameid=frame1&kuang=img_sl&img_sl=<%=img_sl%>&s_pic=<%=s_pic%>&s_typ=<%=s_typ%>&s_wid=<%=s_wid%>&s_hei=<%=s_hei%>" width="380" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="img_sl" id="img_sl" value="<%=img_sl%>"></td>
    </tr>
    <tr class="tdbg" style="display:none;">          
        <td width="120" align="right"><strong>多图上传：</strong></td>          
        <td ><IFRAME id="fra" name="fra"  height=240 src="../info_img/img_add.asp?info_id=<%=id%>" width="630" frameborder=0 scrolling="auto"></iframe></td>
    </tr>
    <tr class="tdbg" id="dis_dow_sl"  <%if dis_dow_sl="no" then response.write"style='display:none;'" end if%>>          
        ...
        <td ><IFRAME name="frame2" id="frame2" style="margin-top:2px;"height=22 src="updloadd.asp?frameid=frame2&kuang=dow_sl&img_sl=<%=dow_sl%>" width="380" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="dow_sl" id="dow_sl" value="<%=dow_sl%>"></td>
    </tr>
    <tr class="tdbg" id="dis_vid_sl"  <%if dis_vid_sl="no" then response.write"style='display:none;'" end if%>>          
        ...
        <td ><IFRAME name="frame3" id="frame3" style="margin-top:2px;"height=22 src="upvloadd.asp?frameid=frame3&kuang=vid_sl&img_sl=<%=vid_sl%>" width="380" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="vid_sl" id="vid_sl" value="<%=vid_sl%>"></td>
    </tr>
...
<!--中文版优化-->
<tr>
    <td class="tdbg" align="right"><b>搜索优化：</b></td>
    <td>
...
<p align="center">   
<INPUT type=submit id=b1 name=b1   value=" 修 改 " > &nbsp;       <input name="Cancel" type="button" id="Cancel" value=" 取 消 " onClick="location='default.asp<%=url_attr%>'" style="cursor:hand;">  </p><br>
</form>
