...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg"> 
        ...
        <td>
	   <select name="lm" onChange="check_display()" id="lm">
	 ...
	 //alert("<%=id_lm%>");
	 //alert(document.getElementById("lm").value);	 
	 document.getElementById("lm").value="<%=id_lm%>";
    ...
    <tr class="tdbg" >           
     <td width="120" align="right"><strong>信息标题：</strong></td>          
      <td ><div  1style="display:none;"><input name="title" type="text" id="title"  size="44" maxlength="150">              
    ...
    <tr class="tdbg"  id="dis_f_body" style="display:none;">
        ...
        <td >
<!--        <textarea name="f_body" cols="72" rows="4" id="f_body"></textarea>-->
    ...
    <tr class="tdbg" id="dis_img_sl" style="display:none;">          
        ...
        <td ><IFRAME name="frame1" id="frame1" style="margin-top:2px;"height=22 src="up.asp?frameid=frame1&kuang=img_sl" width="380" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="img_sl" id="img_sl"></td>
    </tr>
    <tr class="tdbg" style="display:none;">          
        <td width="120" align="right"><strong>多图上传：</strong></td>          
        <td ><IFRAME id="fra" name="fra"  height=240 src="../info_img/img_add.asp" width="630" frameborder=0 scrolling="auto"></iframe></td>
    </tr>
    <tr class="tdbg" id="dis_dow_sl" style="display:none;">          
        <td width="120" align="right"><strong>文件上传：</strong></td>          
        <td ><IFRAME name="frame2" id="frame2" style="margin-top:2px;"height=22 src="upd.asp?frameid=frame2&kuang=dow_sl" width="380" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="dow_sl" id="dow_sl"></td>
    </tr>
    <tr class="tdbg" id="dis_vid_sl" style="display:none;">          
        <td width="120" align="right"><strong>视频上传：</strong></td>          
        <td ><IFRAME name="frame3" id="frame3" style="margin-top:2px;"height=22 src="upv.asp?frameid=frame3&kuang=vid_sl" width="380" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="vid_sl" id="vid_sl"></td>
    </tr>
...
<p align="center">   
		<INPUT type="submit" id="b1" name="b1"   value=" 添 加 " > &nbsp;       <input name="Cancel" type="button" id="Cancel" value=" 取 消 " onClick="location='default.asp<%=url_attr%>'" style="cursor:hand;">  </p><br>
	</form>
