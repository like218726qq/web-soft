...
if z_body<>"" then
	conn.execute"update book set huifu='yes',z_body='"&z_body&"' where id="&id&""
else
	conn.execute"update book set huifu='no',z_body='"&z_body&"'  where id="&id&""
end if

call msg("成功回复","location='"&w_url&"'")
%>
