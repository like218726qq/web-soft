...
<table width="100%"  border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr>
    ...
    <td class="tdbg">
    <input name="title2" type="text" id="title2" size="30" maxlength="150" value="<%=title%>" disabled="disabled">
    <input name="title" type="hidden" id="title" size="30" maxlength="150" value="<%=title%>">
    </td>
  </tr>
   <tr>
