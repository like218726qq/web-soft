              ...
              <TBODY><TR>
		       ...
		       <!-- <input type="submit" value="修改选中排序" name="submit1"  onClick="return confirm('真的要修改选中排序吗?')">-->
                <select name="ac" id="ac">
                    ...
                    <input type="submit" value="提交操作" name="submit1"  onClick="return confirm('确定要提交操作吗?')">
