...
<table width="100%" border="0"  cellpadding="2" cellspacing="1" class="border">  
    <tr class="topbg"> 
        <td  colspan="2"  align="center">产品图片中心管理----添加产品图片</td>  
    </tr>  
    <tr class="tdbg">   
        <td width="70" height="26" ><strong>管理导航：</strong></td>
        <td><a href="default.asp">产品图片管理首页</a>&nbsp;|&nbsp;<a href="add.asp">添加产品图片</a>&nbsp;</td>
    </tr>
</table>
<br />
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    <tr class="title">      
         <td  align="center" colspan="2"><b>添加产品图片</b></td>   
    </tr>    
    ...
    <tr class="tdbg" >           
     <td width="120" align="right"><strong>产品图片标题：</strong></td>          
    ...
    <tr class="tdbg" id="dis_info_from" style="display:none;">           
         <td width="120" align="right"><strong>产品图片来源：</strong></td>          
         <td ><input name="info_from" type="text" id="info_from"   maxlength="50">
          &nbsp; 产品图片作者：<input name="info_author" type="text" id="info_author"   maxlength="50"/></td >
    </tr>
    <tr class="tdbg"  id="dis_f_body" style="display:none;">
        <td align="right" valign="top"><strong><br>产品图片精要：</strong></td>
        <td ><textarea name="f_body" cols="72" rows="4" id="f_body"></textarea></td>
    </tr>
    <tr class="tdbg" id="dis_z_body"  style="display:none;">          
        <td width="120" align="right" valign="middle"><p><strong>产品图片内容：<br></strong><br></td>
    <td >
