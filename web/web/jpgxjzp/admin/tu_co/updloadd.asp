...
if ac="" then
	if img_sl="" then
		response.write"<script>location='upd.asp?frameid="&frameid&"&kuang="&kuang&"'</script>"
	else
		response.write"&nbsp;<img src='../images/img.gif' onmouseover=popImage(this,'../../"&img_sl&"'); onmouseout=hideLayer();>　<a href='updloadd.asp?frameid="&frameid&"&kuang="&kuang&"&img_sl="&img_sl&"&ac=del' onclick='return confirm(""确定要删除文件吗？"")'>删除文件,重新上传</a>"
	end if
elseif ac="del" then
	if img_sl<>"" then
		delfile("../../"&img_sl)
