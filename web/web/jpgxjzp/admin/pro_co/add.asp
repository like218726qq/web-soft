...
<form method="POST" name="form1" action="addd.asp" onSubmit="return check()" >
		...
		<tr class="tdbg">
          ...
          <tr class="tdbg" style="display:none;">
			...
			attrs=Array()
			attrs_value=Array("","","","","","","","","","","")
			attrs_value_en=Array("","","","","","","","","","","")
			For b = 0 To UBound(attrs)
			%>
             <tr>
             <td width=100 align="right"><b><%=attrs((b))%>:</b></td><td width=120><input type="text" value="<%=attrs_value((b))%>" name="<%="pro_can"&(b+1)%>"/></td>
            ...
            <tr class="tdbg" style="display:none;">
                ...
                <td><textarea name="f_body_en" cols="72" rows="4" id="f_body_en"></textarea></td>
            </tr>
    ...
    <textarea name="z_body_en" style="width:600px;height:400px;visibility:hidden;" class="kindeditor4"><%=tohtml(z_body_en)%></textarea>                  
        ...
        <tr class="tdbg" >          
            ...
            <td ><IFRAME id="frame1" name="frame1" style="margin-top:2px;"height=22 src="up.asp?frameid=frame1&kuang=img_sl" width="380" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="img_sl" id="img_sl"></td>
        </tr>
...
<tr style="display:none;">
 ...
 <!--英文版优化-->
  ...
  <p align="center">
  <input type="submit" name="Submit" value=" 添 加 "> &nbsp;       <input type="button" name="Submit2" value=" 取 消 " onClick="location='default.asp<%=url_attr%>'"></p>
</form>
