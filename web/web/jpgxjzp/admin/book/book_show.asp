...
<table width='100%' border='0' align='center' cellpadding='2' cellspacing='1' class='border'>
    <tr class='topbg'>
        <td  align='center'><strong>留言簿中心管理----</strong>查看留言</td>
    </tr>
</table>
<BR>
		<TABLE class=border cellSpacing=1 cellPadding=2 width="100%" border=0>
          ...
          <TR class="tdbg2" >
            ...
            <TD width="73%" align="left" valign="top" class="tdbg2">
              <textarea name="z_body" cols="60" rows="6"><%=z_body%></textarea></TD>
          </TR>
          <TR class="tdbg2" >
            <TD width="27%" height="40" align="right" class="tdbg2">回复内容：</TD>
            <TD width="73%" align="left" valign="top" class="tdbg2">
              <textarea name="f_body" cols="60" rows="6"><%=h_z_body%></textarea></TD>
          </TR>
          <TR >
            <TD width="27%" align="right" valign="top" class="tdbg2"></TD>
            <TD width="73%" align="left" valign="top" class="tdbg2">
              <input type="button" name="Submit2" value="返 回" onClick="location='<%=w_url%>'">            
              <input type="submit" name="Submit2" value="回 复">
              </TD>
          </TR></form>
</TABLE>
