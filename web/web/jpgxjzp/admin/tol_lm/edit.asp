...
<TABLE width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  ...
  <TR class="tdbg">   
	  ...
	  <TD height="26">
		 <A href="default.asp">栏目管理首页</A>&nbsp;<A href="add.asp" style="display:none;">|&nbsp;添加栏目</A>
	  </TD>
  </TR>
</TABLE>
<br>
  ...
  <TD>
    ...
    <TR class="tdbg" style="display:none;">
		...
		<TD>
			...
			<input type="radio" name="add_xx" value="no" <%if add_xx="no" then response.write" checked" end if%>>否 可以添加信息，(不能添加信息时只做为栏目导航)
