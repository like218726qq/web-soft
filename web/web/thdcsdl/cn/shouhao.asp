			   ...
			   <tr>
				...
				lm=request.QueryString("lm")
				 if lm="" then lm=18
				  ...
				  %>	
				<tr><td>
				<span <%if lm=16 then response.Write("style=""display:none""") end if%>><%=z_body%></span>
				<a <%if lm<>16 then response.Write("style=""display:none""") end if%> href="../<%=img_sl%>"><%=title%></a>
				</td>
				</tr>
				  <%
				  	  rs.movenext
