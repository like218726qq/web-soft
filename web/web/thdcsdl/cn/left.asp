<table width="207" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				%>
                          ...
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="10">&nbsp;</td>
                                <td class="boby"><a  href="product.asp?id=<%=rs("id")%>"><%=rs("title")%></a></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
					...
					sql="select * from info_co where id="&rs("id")&" order by px desc,id desc"
					rsb.open sql,conn,1,1
					if not rsb.eof then
						do until rsb.eof 
				%>
					  <!--二级-->
                      <tr <%if fid<>cstr(rs("id")) then response.write("style=""display:none""") end if%>>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="8" ></td>
                          </tr>
                          <tr>
                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="10">&nbsp;</td>
                                  <td class="boby">
								  <a  href="product.asp?fid=<%=rs("id")%>&lid=<%=rsb("id")%>">
					<%=rsb("title")%></a></td>
                                </tr>
                            </table></td>
                          </tr>
