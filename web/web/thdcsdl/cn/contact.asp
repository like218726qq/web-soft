<!--#include file="conn.asp"-->
              <%		
				  ...
				  rs.open "select * from tol_co where ID=1",conn,1,1
				  if not rs.eof then
				  title=rs("title")					 
				  z_body=rs("z_body")
				  end if
	...
	<!--#include file="top1.asp"-->
      ...
      <tr>
		...
		<div style="padding-top:5px;" class="Products">	  首页 >> <%=title%></div>
			  ...
			  <!--main-->
			   <tr>
                <td height="380" colspan="2" bgcolor="#FFFFFF" style="padding-left:10px; padding-top:10px; line-height:24px; font-size:12px;">	
				<%=z_body%>
				</td>
              </tr>
