...
if rs.eof then call msg("该管理员不存在或已删除","")
...
<form name="form1" action="editt.asp" method="post" onSubmit="return check()">
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="border">
  <tr>
   ...
   <tr>
    ...
    <td class="tdbg"><input name="password1" type="text" id="password1" maxlength="50"   value="<%=password%>">
    <font color="#FF0000">(6-12位字母+数字组成)</font></td>
  </tr>
   <tr>
    <td width="120" height="22" align="right" class="tdbg"><strong>确认密码：</strong></td>
    <td class="tdbg"><input name="password2" type="text" id="password2" maxlength="50"  value="<%=password%>"></td>
  </tr>
   <tr>
