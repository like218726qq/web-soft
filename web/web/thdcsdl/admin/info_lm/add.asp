...
<td>
  ...
  <tr class="tdbg"  id="gaoji" style="display:none;">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="30"><label>
          <input name="xia" type="radio" id="xia" value="yes" checked>
          是
          <input type="radio" name="xia" id="xia" value="no">
        否 有下级栏目</label></td>
      </tr>
      <tr>
        <td height="30"><label>
          <input type="radio" name="uselink" id="uselink" value="yes">
          是
          <input name="uselink" type="radio" id="uselink" value="no" checked>
        否 有外部连接</label></td>
      </tr>
      <tr>
        <td height="30">
          <input type="radio" name="info_from" id="info_from" value="yes">
          是
      ...
      <tr>
        <td height="30">
          <input type="radio" name="f_body" id="f_body" value="yes">
          是
          <input name="f_body" type="radio" id="f_body" value="no" checked>
        否 有简要介绍</td>
      </tr>
      <tr>
        <td height="30">
          <input name="z_body" type="radio" id="z_body" value="yes" checked>
          是
          <input type="radio" name="z_body" id="z_body" value="no">
        否 有详细介绍</td>
      </tr>
      <tr>
        <td height="30">
          <input type="radio" name="img_sl" id="img_sl" value="yes" onclick="document.getElementById('tr_s').style.display=''">
          是
          <input name="img_sl" type="radio" id="img_sl" value="no" checked onclick="document.getElementById('tr_s').style.display='none'">
        否 有文件上传</td>
      </tr>
      ...
      <tr>
        <td height="30">
          <input name="wtime" type="radio" id="wtime" value="yes" checked>
          是
          <input name="wtime" type="radio" id="wtime" value="no">
        否 有发布时间</td>
      </tr>
