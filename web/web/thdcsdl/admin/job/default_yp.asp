...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
  <tr class="topbg">
    <td  colspan="2"  align="center">企业招聘管理----应聘管理首页</td>
  </tr>
  <tr class="tdbg">
...
<br />
<FORM name=form1  action="make.asp?ac=dell" method=post target="theblank" onsubmit="return checkyes(form1);">
...
<TBODY>
          ...
          <TR class=tdbg onMouseOver="DoHL();" onMouseOut="DoLL();" onClick="DoSL();">
                ...
                <TD align="center" ><A href="yp_show.asp?id=<%=rs("id")%>"  >查看</A>&nbsp;<A href="make.asp?id=<%=rs("id")%>&ac=dell" target="theblank" onClick="return confirm('确定要删除此简历吗？');">删除</A>&nbsp;</TD>
              </TR>
				<%
				a=a+1
				rs.movenext
