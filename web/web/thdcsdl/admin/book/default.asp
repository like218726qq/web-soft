...
'		end if
		%>
              <TR class=tdbg onMouseOver="DoHL();" onMouseOut="DoLL();" onClick="DoSL();">
                ...
                <%else%>
              <!--    <A href="make.asp?ac=ping2&id=< %=rs("id")%>" target="theblank" >审核</A>-->
                <%end if%>|
                  <A onClick="return confirm('确定要删除此留言吗？');" href="make.asp?ac=del&id=<%=rs("id")%>" target="theblank">删除</A>
                </TD>
              </TR>
				<%
				  a=a+1
...
<IFRAME id=theblank name=theblank style="WIDTH: 0px; HEIGHT: 0px" src="images/blank.htm"></IFRAME>
<br />
<br>
<B>说明</B>：<br>
