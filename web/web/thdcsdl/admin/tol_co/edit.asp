...
<tr class="tdbg">
    ...
    <td><input name="px" type="text" id="px" value="<%=px%>" size="10" maxlength="10" >
      <FONT color=red>*(从大到小排序)</FONT></td>
		...
		<INPUT type="submit" id="b1" name="b1"   value=" 修 改 " > &nbsp;       <input name="Cancel" type="button" id="Cancel" value=" 取 消 " onClick="location='<%=request.ServerVariables("HTTP_REFERER")%>'" style="cursor:hand;">  </p>
</form>
</body>
</html>
