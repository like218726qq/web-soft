	...
	for (i=0;i<=counter;i++){
		if (lm==shu_lm[i][0]){
			...
			if(shu_lm[i][5]=="yes"){
				...
				dis_frame1.src="up.asp?frameid=frame1&kuang=img_sl&s_pic="+shu_lm[i][7]+"&s_typ="+shu_lm[i][8]+"&s_wid="+shu_lm[i][9]+"&s_hei="+shu_lm[i][10];
			}else{
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <input name="link_url" type="text" id="link_url" size="50" maxlength="150" disabled="yes" value="http://"></td>
    </tr>
    <tr class="tdbg" id="dis_info_from" style="display:none;">           
         <td width="120" align="right"><strong>信息来源：</strong></td>          
         <td ><input name="info_from" type="text" id="info_from"   maxlength="50" value="本站">
          &nbsp; 信息作者：<input name="info_author" type="text" id="info_author"   maxlength="50" value="本站"/></td >
    </tr>
