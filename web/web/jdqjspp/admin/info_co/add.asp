...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg" id="dis_img_sl" style="display:none;">          
        ...
        <td ><IFRAME name="frame1" id="frame1" style="margin-top:2px;"height=22 src="up.asp?frameid=frame1&kuang=img_sl" width="420" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="img_sl" id="img_sl"></td>
    </tr>
    <tr class="tdbg" id="dis_dow_sl" style="display:none;">          
        <td width="120" align="right"><strong>文件上传：</strong></td>          
        <td ><IFRAME name="frame2" id="frame2" style="margin-top:2px;"height=22 src="upd.asp?frameid=frame2&kuang=dow_sl" width="420" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="dow_sl" id="dow_sl"></td>
    </tr>
    <tr class="tdbg" id="dis_vid_sl" style="display:none;">          
        <td width="120" align="right"><strong>视频上传：</strong></td>          
        <td ><IFRAME name="frame3" id="frame3" style="margin-top:2px;"height=22 src="upv.asp?frameid=frame3&kuang=vid_sl" width="420" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="vid_sl" id="vid_sl"></td>
    </tr>
