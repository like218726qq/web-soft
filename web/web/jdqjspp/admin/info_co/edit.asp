...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg" id="dis_img_sl"  <%if dis_img_sl="no" then response.write"style='display:none;'" end if%>>          
        ...
        <td ><IFRAME id="frame1" name="frame1" style="margin-top:2px;"height=22 src="uploadd.asp?frameid=frame1&kuang=img_sl&img_sl=<%=img_sl%>&s_pic=<%=s_pic%>&s_typ=<%=s_typ%>&s_wid=<%=s_wid%>&s_hei=<%=s_hei%>" width="420" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="img_sl" id="img_sl" value="<%=img_sl%>"></td>
    </tr>
    <tr class="tdbg" id="dis_dow_sl"  <%if dis_dow_sl="no" then response.write"style='display:none;'" end if%>>          
        ...
        <td ><IFRAME name="frame2" id="frame2" style="margin-top:2px;"height=22 src="updloadd.asp?frameid=frame2&kuang=dow_sl&img_sl=<%=dow_sl%>" width="420" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="dow_sl" id="dow_sl" value="<%=dow_sl%>"></td>
    </tr>
    <tr class="tdbg" id="dis_vid_sl"  <%if dis_vid_sl="no" then response.write"style='display:none;'" end if%>>          
        ...
        <td ><IFRAME name="frame3" id="frame3" style="margin-top:2px;"height=22 src="upvloadd.asp?frameid=frame3&kuang=vid_sl&img_sl=<%=vid_sl%>" width="420" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="vid_sl" id="vid_sl" value="<%=vid_sl%>"></td>
    </tr>
