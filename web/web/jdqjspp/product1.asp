    	 ...
    	 <div class="listR">
            ...
            <div class="R1">
                ...
                <div class="licon">
                    ...
                    tt=tt&" and title like '%"&keyword&"%'"
								...
								sql="select id,title,img_sl from pro_co where pass='yes' and lm=1 "&sq&" order by px desc,id desc"
								end if
								rs.open sql,conn,1,1
								if not rs.eof then
									pagenum=12
			...
			<!--<td  align="left" style="padding-top:10px; padding-left:15px;">
				...
				<div style="text-align:center; margin-top:100px; margin-left:200px; width:200px; vertical-align:top; font-size:12px;">暂无相关产品<span style="color:#FF0000"><strong><%=html(request.Form("keyword"))%></strong></span>信息！</div>
						...
						%> 
                        	<div class="clear"></div>
                       <br /><div style="font-size:12px; margin-left:100px;"><%if pagenum<>"" then call listpage(page) end if%></div>                     
                    </ul>
